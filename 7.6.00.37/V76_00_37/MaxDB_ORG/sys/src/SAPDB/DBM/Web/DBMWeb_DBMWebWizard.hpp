/*! 
  -----------------------------------------------------------------------------
  module: DBMWeb_DBMWebWizard.hpp
  -----------------------------------------------------------------------------
  responsible:  MartinR
  special area: Database Manager WebAgent Extension
  description:  the "Wizard" section of "the" DBMWeb Class
...
#ifndef _DBMWEB_DBMWEBWIZARD_HPP_
#define _DBMWEB_DBMWEBWIZARD_HPP_

SAPDB_Bool wizardDB ( sapdbwa_WebAgent      &wa,
                      sapdbwa_HttpRequest   &request,
                      sapdbwa_HttpReply     &reply );


#endif // _DBMWEB_DBMWEBWIZARD_HPP_
