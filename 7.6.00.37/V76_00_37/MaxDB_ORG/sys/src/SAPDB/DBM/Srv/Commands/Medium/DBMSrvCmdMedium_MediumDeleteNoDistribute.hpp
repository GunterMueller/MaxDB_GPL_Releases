/*!
  \file    DBMSrvCmdMedium_MediumDeleteNoDistribute.hpp
  \author  TiloH
...
class DBMSrvCmdMedium_MediumDeleteNoDistribute : public DBMSrv_Command
{
  public:
    DBMSrvCmdMedium_MediumDeleteNoDistribute();
    ~DBMSrvCmdMedium_MediumDeleteNoDistribute();
