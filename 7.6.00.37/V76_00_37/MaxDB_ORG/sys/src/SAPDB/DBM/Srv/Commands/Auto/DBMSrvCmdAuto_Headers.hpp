/*!
  \file    DBMSrvCmdAuto_Headers.hpp
  \author  TiloH
  \ingroup DBM Server commands
  \brief   includes of headers from DBM/Srv/Commands/Auto/
...
#if !defined(DBMSRVCMDAUTO_HEADERS_HPP)
#define DBMSRVCMDAUTO_HEADERS_HPP

#include "DBM/Srv/Commands/Auto/DBMSrvCmdAuto_AutoExtend.hpp"
#include "DBM/Srv/Commands/Auto/DBMSrvCmdAuto_AutoRecover.hpp"
