/*!
  \file    DBMSrvCmdScd_SchedulerStart.hpp
  \author  MarcW
...
#if !defined(DBMSrvCmdScd_SchedulerStart_hpp)
#define DBMSrvCmdScd_SchedulerStart_hpp


/*! 
    @brief Class for handling the DBMServer command scheduler_start
*/
class DBMSrvCmdScd_SchedulerStart: public DBMSrvCmdScd_SchedulerCommand {
public:
    /*! @brief constructor */
    DBMSrvCmdScd_SchedulerStart();
...
#endif //DBMSrvCmdScd_SchedulerStart_hpp
