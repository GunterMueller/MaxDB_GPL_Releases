/*!
  \file    DBMSrvCmdDbm_ListMemoryerror.hpp
  \author  MarcW
...
#if !defined(DBMSrvCmdDbm_DbmListMemoryerror_hpp)
#define DBMSrvCmdDbm_DbmListMemoryerror_hpp

/*! 
    @brief Class for handling the DBMServer command dbm_list_memoryerror
*/
class DBMSrvCmdDbm_DbmListMemoryerror: public DBMSrv_Command {
public:
    /*! @brief constructor */
    DBMSrvCmdDbm_DbmListMemoryerror();
...
#endif //DBMSrvCmdDbm_DbmListMemoryerror_hpp
