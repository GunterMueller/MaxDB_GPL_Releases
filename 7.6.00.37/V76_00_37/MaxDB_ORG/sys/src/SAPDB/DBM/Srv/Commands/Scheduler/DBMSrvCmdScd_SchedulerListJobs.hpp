/*!
  \file    DBMSrvCmdScd_SchedulerListJobs.hpp
  \author  MarcW
...
#if !defined(DBMSrvCmdScd_SchedulerListJobs_hpp)
#define DBMSrvCmdScd_SchedulerListJobs_hpp


/*! 
    @brief class for handling the DBMServer command scheduler_list
*/
class DBMSrvCmdScd_SchedulerListJobs: public DBMSrvCmdScd_SchedulerCommand {
public:
    /*! @brief constructor */
    DBMSrvCmdScd_SchedulerListJobs();
...
#endif //DBMSrvCmdScd_SchedulerListJobs_hpp
