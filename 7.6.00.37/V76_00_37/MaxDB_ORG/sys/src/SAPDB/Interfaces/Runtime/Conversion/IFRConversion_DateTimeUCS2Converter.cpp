/*!
  @file           IFRConversion_DateTimeUCS2Converter.cpp
  @author         D039759
...
//----------------------------------------------------------------------
IFRConversion_DateTimeUCS2Converter::IFRConversion_DateTimeUCS2Converter(IFR_ShortInfo& shortinfo,
...
//----------------------------------------------------------------------
IFRConversion_DateTimeUCS2Converter::~IFRConversion_DateTimeUCS2Converter()
{}

//----------------------------------------------------------------------
IFR_Retcode 
IFRConversion_DateTimeUCS2Converter::appendAsciiInput(IFRPacket_DataPart& datapart,
                                                  char               *data,
...
{
    DBUG_CLINK_METHOD_ENTER(IFRConversion_DateTimeUCS2Converter, appendAsciiInput);
...
//----------------------------------------------------------------------
IFR_Retcode 
IFRConversion_DateTimeUCS2Converter::appendUCS2Input(IFRPacket_DataPart&  datapart,
                                                     char                *data,
                                                     IFR_Bool            swapped,
                                                     IFR_Length           datalength,
                                                     IFR_Length*          lengthindicator,
                                                     ...
                                                     IFRConversion_Putval *putval)
{
    DBUG_CLINK_METHOD_ENTER(IFRConversion_DateTimeUCS2Converter, appendUCS2Input);
...
//----------------------------------------------------------------------
IFR_Retcode 
IFRConversion_DateTimeUCS2Converter::appendUTF8Input(IFRPacket_DataPart& datapart,
                                             char               *data,
                                             IFR_Length            datalength,
                                             IFR_Length*           lengthindicator,
                                                     IFR_Bool      terminate,
...
//----------------------------------------------------------------------
IFR_Retcode
IFRConversion_DateTimeUCS2Converter::appendBinaryInput(IFRPacket_DataPart& datapart,
                                                    char               *data,
                                                    IFR_Length            datalength,
                                                    IFR_Length*           lengthindicator,
                                                    IFR_ConnectionItem & clink,
                                                    ...
                                                    IFRConversion_Putval *putval)
{
    DBUG_CLINK_METHOD_ENTER(IFRConversion_DateTimeUCS2Converter, appendBinaryInput);
...
//----------------------------------------------------------------------
IFR_Retcode 
IFRConversion_DateTimeUCS2Converter::appendBinaryOutput(IFRPacket_DataPart&   datapart,
                                                char                 *data,
                                                IFR_Length            datalength,
                                                IFR_Length*           lengthindicator,
                                                IFR_ConnectionItem   &clink,
...
{
    DBUG_CLINK_METHOD_ENTER(IFRConversion_DateTimeUCS2Converter, appendBinaryOutput);
...
//----------------------------------------------------------------------
IFR_Retcode
IFRConversion_DateTimeUCS2Converter::translateInput(IFRPacket_DataPart& part,
...
//----------------------------------------------------------------------
IFR_Retcode
IFRConversion_DateTimeUCS2Converter::translateOutput(IFRPacket_DataPart& part,
                                                 SQL_TIME_STRUCT& data,
                                                 IFR_Length* lengthindicator,
                                                 IFR_ConnectionItem& clink)
{
    DBUG_CLINK_METHOD_ENTER(IFRConversion_DateTimeUCS2Converter, translateOutput);
    SQL_TIMESTAMP_STRUCT tmp_timestamp;
    IFR_Length             tmp_lengthindicator;
    IFR_Retcode rc = IFRConversion_UCS2CharDataConverter::translateOutput
                                                 ...
                                                 IFR_ConnectionItem& clink)
{
    ...
    IFR_Length             tmp_lengthindicator;
    IFR_Retcode rc=
        IFRConversion_UCS2CharDataConverter::translateOutput(part, tmp_timestamp, &tmp_lengthindicator, clink);
    if(rc == IFR_OK) {
