...
\endif
*/
/* streamtest.cpp : Dllmain + Factory + registration of the Stored Procedure*/
/****************************************************************************/
#define   INITGUID

#include <lcbasetypes.h>
#include <livecachetypes.h>
#include "streamtest.h" /* no check */
#include "SAPDB/Interfaces/SQLDBC/tests/DBProc/streamtestObj.h"
#include "streamtest_i.c" /* no check */
...
class CstreamtestFactory : public IClassFactory {
private:
	long m_cRef;
public:
	CstreamtestFactory() : m_cRef(1) {}
	~CstreamtestFactory() {}
  ...
  STDMETHODIMP CreateInstance(IUnknown* pUnknownOuter,
    ...
    Cstreamtest* pCstreamtest = new Cstreamtest ;
    if (pCstreamtest == NULL)
      return E_OUTOFMEMORY;
    return pCstreamtest->QueryInterface(iid, ppv);
  }
...
{
  if (rclsid != CLSID_streamtest)
  {
    return CLASS_E_CLASSNOTAVAILABLE;
  }
 
  CstreamtestFactory* pFactory = new CstreamtestFactory;
  if (pFactory == NULL)  
  {
    return E_OUTOFMEMORY;
  }
...
{
  return co90RegisterComObject ((char*)PROGIDPFX, (char*)"streamtest", 
	(char*)LiveCacheApplVersion, CLSID_streamtest, (char*)g_CModul.m_szModule );
}
...
{
  return co90UnregisterComObject ((char*)PROGIDPFX, (char*)"streamtest", 
  (char*)LiveCacheApplVersion, CLSID_streamtest, (char*)g_CModul.m_szModule );
}
