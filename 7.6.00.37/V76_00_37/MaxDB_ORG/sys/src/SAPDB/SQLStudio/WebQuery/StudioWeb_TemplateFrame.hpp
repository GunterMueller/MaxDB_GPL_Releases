...
/*!**********************************************************************
  ...
  module: StudioWeb_TemplateFrame.hpp
...
#ifndef STUDIOWEB_TEMPLATEFRAME_HPP
#define STUDIOWEB_TEMPLATEFRAME_HPP
...
/*!
  -----------------------------------------------------------------------------
  Class:        StudioWeb_TemplateFrame
  -----------------------------------------------------------------------------
  description:  An instance of this class represents a HTML-Page with a 
                Info Table.
  -----------------------------------------------------------------------------
*/
class StudioWeb_TemplateFrame : public Tools_Template 
{
  public:
     ...
     /*!-------------------------------------------------------------------------
      ...
      -------------------------------------------------------------------------*/
     StudioWeb_TemplateFrame (sapdbwa_WebAgent &wa,Tools_DynamicUTF8String  sSessionID,SAPDB_Bool bWithTree);
