/*!
    \file    ToolsParsersOldSyntEl_Set.hpp
    \author  TiloH
...
#if !defined (ToolsParsersOldSyntEl_Set_HPP)
#define ToolsParsersOldSyntEl_Set_HPP
...
class ToolsParsersOldSyntEl_Set: public ToolsParsersOldSyntEl_ParameterGroup
{
  protected:
    /*! \brief function implementing the virtual parse function of ToolsParsersOldSyntEl_ParameterBase
        for ToolsParsersOldSyntEl_Set.
        
        Parsing in array arrayToParse starting at the first
        array element. The child objects organized by a ToolsParsersOldSyntEl_Set will be
