/*!
    \file    ToolsParsersSyntEl_NonTerminal.hpp
    \author  TiloH
    \ingroup syntax elements for parsers
    \brief   declaration of a base class for non terminal elements
...
#if !defined(TOOLSPARSERSSYNTEL_NONTERMINAL_HPP)
#define TOOLSPARSERSSYNTEL_NONTERMINAL_HPP
...
class ToolsParsersSyntEl_NonTerminal: public ToolsParsersSyntEl_ParameterBase
{
  public:
