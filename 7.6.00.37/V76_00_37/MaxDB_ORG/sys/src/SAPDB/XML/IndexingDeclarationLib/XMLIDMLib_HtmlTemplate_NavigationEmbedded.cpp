/****************************************************************************
  ...
  module      : XMLIDMLib_HtmlTemplate_NavigationEmbedded.cpp
...
*****************************************************************************/
	...
	XMLIDMLib_HtmlTemplate_NavigationEmbedded::XMLIDMLib_HtmlTemplate_NavigationEmbedded (sapdbwa_WebAgent		&wa,
	...
	XMLIDMLib_HtmlTemplate_NavigationEmbedded::~XMLIDMLib_HtmlTemplate_NavigationEmbedded() 
	{
	}

	XMLIDMLIB_Int2 XMLIDMLib_HtmlTemplate_NavigationEmbedded :: askForWriteCount(const Tools_DynamicUTF8String & szName)
	{
		return 1;
	} 


	Tools_DynamicUTF8String XMLIDMLib_HtmlTemplate_NavigationEmbedded :: askForValue (const Tools_DynamicUTF8String & szName)
	{
