#ifndef XMLIDMLIB_HTMLTEMPLATE_CLIENTXIEADMIN_HPP
#define XMLIDMLIB_HTMLTEMPLATE_CLIENTXIEADMIN_HPP
/****************************************************************************

  module      : XMLIDMLib_HtmlTemplate_ClientXieAdmin.hpp
...
*****************************************************************************/
	...
	// Defines
	//===================================================================*/
	#define TEMPLATE_CLIENT_XIEADMIN						"XMLIDMLib_Html_ClientXieAdmin.htm"
	...
	/*===================================================================
	// Class XMLIDMLib_HtmlTemplate_ClientXieAdmin
	//===================================================================*/
	class XMLIDMLib_HtmlTemplate_ClientXieAdmin : public Tools_Template 
	{
		public:

			XMLIDMLib_HtmlTemplate_ClientXieAdmin(sapdbwa_WebAgent & wa,
										   		 sapdbwa_HttpRequest &req);
			
			~XMLIDMLib_HtmlTemplate_ClientXieAdmin();
