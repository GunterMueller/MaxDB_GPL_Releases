/*!
  @file        SrvTasks_JobJoinInvSelector.cpp
  @author      UweH
  @ingroup     ServerTasks
  @brief       This is the implementation of SrvTasks_JobJoinInvSelector
  @since       2004-06-08
...
SrvTasks_Job::Result
SrvTasks_JobJoinInvSelector::ExecuteIntern (Trans_Context &trans)
{
    tgg00_BasisError &trError = trans.OldTrans().trError_gg00;
    
    Join_InvSelectByServer (trans, m_Input);
