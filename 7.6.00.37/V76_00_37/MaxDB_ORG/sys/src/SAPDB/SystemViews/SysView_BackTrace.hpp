/*!
  @file           SysView_BackTrace.hpp
  @author         ThomasA
  @ingroup        SystemViews
  @brief   This contains a class object representing the SYSDD.BACKTRACE table.
  @see            
*/
/*
...
#ifndef SYSVIEW_BACKTRACE_HPP
#define SYSVIEW_BACKTRACE_HPP
...
/*!
   @class    SysView_BackTrace
   @brief    This class is used to handle the system table named
             SYSDD.BACKTRACE. This table is used by the dbproc debugger to return the
             current back trace. The class mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_BackTrace : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_BackTrace(SQLMan_Context  &context,
