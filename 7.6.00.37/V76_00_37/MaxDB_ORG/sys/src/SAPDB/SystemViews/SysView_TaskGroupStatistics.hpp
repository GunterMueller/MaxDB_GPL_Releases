/*!
  @file           SysView_TaskGroupStatistics.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the TASKGROUPSTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_TASKGROUPSTATISTICS_HPP
#define SYSVIEW_TASKGROUPSTATISTICS_HPP
...
/*!
   @class    SysView_TaskGroupStatistics
   @brief    This class is used to handle the system table named
             'TASKGROUPSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_TaskGroupStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_TaskGroupStatistics(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_TASKGROUPSTATISTICS_HPP */
