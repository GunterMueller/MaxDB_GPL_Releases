/*!
  @file           SysView_MachineConfiguration.hpp
  @author         RobinW
  @ingroup        SystemViews
  @brief   This contains a class object representing the MACHINECONFIGURATION view.
  @see            
*/
/*
...
#ifndef SYSVIEW_MACHINECONFIGURATION_HPP
#define SYSVIEW_MACHINECONFIGURATION_HPP
...
/*!
   @class    SysView_Instance
   @brief    This class is used to handle the system table named
             'MACHINECONFIGURATION'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_MachineConfiguration : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_MachineConfiguration(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_MACHINECONFIGURATION_HPP */
