/*!
  @file           SysView_MachineUtilization.hpp
  @author         RobinW
  @ingroup        SystemViews
  @brief   This contains a class object representing the MACHINEUTILIZATION view.
  @see            
*/
/*
...
#ifndef SYSVIEW_MACHINEUTILIZATION_HPP
#define SYSVIEW_MACHINEUTILIZATION_HPP
...
class SysView_MachineUtilization : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_MachineUtilization(SQLMan_Context  &context,
