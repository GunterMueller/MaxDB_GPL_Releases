/*!
  @file           SysView_OMSProcedureStatisticsReset.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the OMSPROCEDURESTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_OMSPROCEDURESTATISTICSRESET_HPP
#define SYSVIEW_OMSPROCEDURESTATISTICSRESET_HPP
...
/*!
   @class    SysView_OMSProcedureStatisticsReset
   @brief    This class is used to handle the system table named
             'OMSPROCEDURESTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_OMSProcedureStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_OMSProcedureStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_OMSPROCEDURESTATISTICSRESET_HPP */
