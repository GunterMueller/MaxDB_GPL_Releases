/*!
  @file           SysView_LogQueueStatistics.hpp
  @author         MartinB
  @ingroup        SystemViews
  @brief   This contains a class object representing the LOGQUEUESTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_LOGQUEUESTATISTICS_HPP
#define SYSVIEW_LOGQUEUESTATISTICS_HPP
...
/*!
   @class    SysView_LogQueueStatistics
   @brief    This class is used to handle the system table named
             'LOGQUEUESTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_LogQueueStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_LogQueueStatistics(SQLMan_Context  &context,
    ...
    /*!
       @brief   Resets all counters of all instandes of Log_Queue
...
#endif  /* SYSVIEW_LOGQUEUESTATISTICS_HPP */
