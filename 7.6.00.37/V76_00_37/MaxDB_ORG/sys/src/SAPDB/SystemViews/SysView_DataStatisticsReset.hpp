/*!
  @file           SysView_DataStatisticsReset.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the DATASTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_DATASTATISTICSRESET_HPP
#define SYSVIEW_DATASTATISTICSRESET_HPP
...
/*!
   @class    SysView_DataStatisticsReset
   @brief    This class is used to handle the system table named
             'DATASTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_DataStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_DataStatisticsReset(SQLMan_Context   &context,
...
#endif  /* SYSVIEW_DATASTATISTICSRESET_HPP */
