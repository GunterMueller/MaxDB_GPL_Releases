/*!========================================================================
  ...
  @file         SysView_TaskLoadBalancingTaskMoves.hpp
  @ingroup      
  @author       RaymondR

  @brief        This header module defines the "TaskLoadBalancingTaskMoves" view class.
...
#ifndef SYSVIEW_TASKLOADBALANCINGTASKMOVES_HPP
#define SYSVIEW_TASKLOADBALANCINGTASKMOVES_HPP
...
/*!
   @class    SysView_TaskLoadBalancingTaskMoves
   @brief    This class is used to handle the system table named
             'TASKLOADBALANCINGTASKMOVES'. It mainly provides 
             the Create() and Execute() functions for this table.
 */


class SysView_TaskLoadBalancingTaskMoves : public SysView_SysViewBase
{
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_TaskLoadBalancingTaskMoves( SQLMan_Context  &context,
...
#endif  /* SYSVIEW_TASKLOADBALANCINGTASKMOVES_HPP */
