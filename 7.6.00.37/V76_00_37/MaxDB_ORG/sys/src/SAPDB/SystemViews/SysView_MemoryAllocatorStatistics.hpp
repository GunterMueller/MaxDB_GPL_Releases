/*!
  @file           SysView_MemoryAllocatorStatistics.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the MEMORYALLOCATORSTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_MEMORYALLOCATORSTATISTICS_HPP
#define SYSVIEW_MEMORYALLOCATORSTATISTICS_HPP
...
/*!
   @class    SysView_MemoryAllocatorStatistics
   @brief    This class is used to handle the system table named
             'MEMORYALLOCATORSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_MemoryAllocatorStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_MemoryAllocatorStatistics(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_MEMORYALLOCATORSTATISTICS_HPP */
