/*!
  @file     SysView_CommandCacheStatistics.hpp
  @author   DirkT
  @ingroup  SystemViews
...
#ifndef SYSVIEW_COMMANDCACHESTATISTICS_HPP
#define SYSVIEW_COMMANDCACHESTATISTICS_HPP
...
/*!
   @class    SysView_CommandCacheStatistics
   @brief    This class is used to handle the system table named
             'COMMANDCACHESTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_CommandCacheStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_CommandCacheStatistics(SQLMan_Context  &context,
