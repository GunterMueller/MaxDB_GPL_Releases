/*!
  @file           SysView_PageLocks.hpp
  @author         ElkeZ
  @ingroup area   SystemViews
  @brief   This contains a class object representing the PAGELOCKS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_PAGELOCKS_HPP
#define SYSVIEW_PAGELOCKS_HPP
...
/*!
   @class    SysView_PageLocks
   @brief    This class is used to handle the system table named
             'PAGELOCKS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_PageLocks : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_PageLocks(SQLMan_Context  &context,
