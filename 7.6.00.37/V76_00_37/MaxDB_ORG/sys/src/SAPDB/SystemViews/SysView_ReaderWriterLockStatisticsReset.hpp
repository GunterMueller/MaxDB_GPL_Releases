/*!
  @file           SysView_ReaderWriterLockStatisticsReset.hpp
  @author         Robin
  @ingroup        SystemViews
  @brief   This contains a class object representing the RWREGIONS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_READERWRITERLOCKSTATISTICSRESET_HPP
#define SYSVIEW_READERWRITERLOCKSTATISTICSRESET_HPP
...
/*!
   @class    SysView_ReaderWriterLockStatisticsReset
   @brief    This class is used to handle the system table named
             'READERWRITERLOCKSTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_ReaderWriterLockStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_ReaderWriterLockStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_READERWRITERLOCKSTATISTICSRESET_HPP */
