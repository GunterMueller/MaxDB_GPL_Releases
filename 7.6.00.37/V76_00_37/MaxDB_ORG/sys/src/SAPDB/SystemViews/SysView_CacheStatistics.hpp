/*!
  @file           SysView_CacheStatistics.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the CACHESTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_CACHESTATISTICS_HPP
#define SYSVIEW_CACHESTATISTICS_HPP
...
/*!
   @class    SysView_CacheStatistics
   @brief    This class is used to handle the system table named
             'CACHESTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.

 */


class SysView_CacheStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_CacheStatistics(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_CACHESTATISTICS_HPP */
