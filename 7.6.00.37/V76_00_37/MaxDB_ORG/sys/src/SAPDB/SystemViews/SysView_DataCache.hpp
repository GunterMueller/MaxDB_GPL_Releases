/*!
  @file           SysView_DataCache.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the DATACACHE view.
  @see            
*/
/*
...
#ifndef SYSVIEW_DATACACHE_HPP
#define SYSVIEW_DATACACHE_HPP
...
/*!
   @class    SysView_DataCache
   @brief    This class is used to handle the system table named
             'DATACACHE'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_DataCache : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_DataCache(SQLMan_Context  &context,
