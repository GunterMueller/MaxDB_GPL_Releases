/*!
  @file           SysView_SpinLockStatistics.hpp
  @author         ElkeZ
  @ingroup        SystemViews
...
#ifndef SYSVIEW_SPINLOCKSTATISTICS_HPP
#define SYSVIEW_SPINLOCKSTATISTICS_HPP
...
/*!
   @class    SysView_SpinLockStatistics
   @brief    This class is used to handle the system table named
             'SPINLOCKSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_SpinLockStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_SpinLockStatistics(SQLMan_Context  &context,
...
private:
    ...
    friend class SysView_SpinLockStatisticsReset;
    /*-----------------------------------------------------------------------*/
    /*@}*/
    /*-----------------------------------------------------------------------*/
};
...
#endif  /* SYSVIEW_SPINLOCKSTATISTICS_HPP */
