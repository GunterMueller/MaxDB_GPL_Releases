/*!
  @file           SysView_Version.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the VERSION view.
  @see
*/
/*
...
#ifndef SYSVIEW_VERSION_HPP
#define SYSVIEW_VERSION_HPP
...
/*!
   @class    SysView_Version
   @brief    This class is used to handle the system table named
             'VERSION'. It mainly provides the Create() and
             Execute() functions for this table.

 */


class SysView_Version : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_Version(SQLMan_Context  &context,
...
private:
    ...
    void GetOSDetails (SAPDB_Char *sOS,
                       SAPDB_Int2 &iBit);

    void GetCPUDetails (SAPDB_Char *sCPU);

    void GetKernelDetails (SAPDB_Char   *sIDString,
