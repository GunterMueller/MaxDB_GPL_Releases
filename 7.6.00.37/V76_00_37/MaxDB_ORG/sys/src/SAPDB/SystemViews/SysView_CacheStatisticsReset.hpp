/*!
  @file           SysView_CacheStatisticsReset.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the CACHESTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_CACHESTATISTICSRESET_HPP
#define SYSVIEW_CACHESTATISTICSRESET_HPP
...
/*!
   @class    SysView_CacheStatisticsReset
   @brief    This class is used to handle the system table named
             'CACHESTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.

 */


class SysView_CacheStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_CacheStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_CACHESTATISTICSRESET_HPP */
