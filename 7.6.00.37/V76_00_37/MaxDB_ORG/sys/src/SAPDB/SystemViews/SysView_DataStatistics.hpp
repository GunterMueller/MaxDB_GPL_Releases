/*!
  @file     SysView_DataStatistics.hpp
  @author   TorstenS
  @ingroup  SystemViews
...
#ifndef SYSVIEW_DATASTATISTICS_HPP
#define SYSVIEW_DATASTATISTICS_HPP
...
/*!
   @class    SysView_DataStatistics
   @brief    This class is used to handle the system table named
             'DATASTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.

 */


class SysView_DataStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_DataStatistics(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_DATASTATISTICS_HPP */
