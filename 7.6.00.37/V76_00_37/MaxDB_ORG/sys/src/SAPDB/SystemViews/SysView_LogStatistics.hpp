/*!
  @file           SysView_LogStatistics.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the LOGSTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_LOGSTATISTICS_HPP
#define SYSVIEW_LOGSTATISTICS_HPP
...
/*!
   @class    SysView_LogStatistics
   @brief    This class is used to handle the system table named
             'LOGSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_LogStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_LogStatistics(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_LOGSTATISTICS_HPP */
