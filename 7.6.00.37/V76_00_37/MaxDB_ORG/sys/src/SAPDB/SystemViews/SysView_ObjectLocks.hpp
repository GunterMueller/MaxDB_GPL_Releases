/*!
  @file           SysView_ObjectLocks.hpp
  @author         ThomasA
  @ingroup        SystemViews
  @brief   This contains a class object representing the OBJECTLOCKS view.
  @see
*/
/*
...
#ifndef SYSVIEW_OBJECTLOCKS_HPP
#define SYSVIEW_OBJECTLOCKS_HPP
...
/*!
   @class    SysView_ObjectLocks
   @brief    This class is used to handle the system table named
             'OBJECTLOCKS'. It mainly provides the Create() and
             Execute() functions for this table.

 */


class SysView_ObjectLocks : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_ObjectLocks(SQLMan_Context  &context,
