...
#ifndef SYSVIEW_SNAPSHOTS_HPP
#define SYSVIEW_SNAPSHOTS_HPP
...
/*!
   ...
   @brief    This class is used to handle the system table named
             'SNAPSHOTS'. It mainly provides the Create() and 
             Execute() functions for this table.

 */


class SysView_Snapshots : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_Snapshots( SQLMan_Context  &context,
