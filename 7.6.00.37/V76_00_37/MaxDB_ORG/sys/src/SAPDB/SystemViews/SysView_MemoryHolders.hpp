/*!
  @file           SysView_MemoryHolders.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the MEMORYHOLDERS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_MEMORYHOLDERS_HPP
#define SYSVIEW_MEMORYHOLDERS_HPP
...
/*!
   @class    SysView_MemoryHolders
   @brief    This class is used to handle the system table named
             'MEMORYHOLDERS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_MemoryHolders : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_MemoryHolders(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_MEMORYHOLDERS_HPP */
