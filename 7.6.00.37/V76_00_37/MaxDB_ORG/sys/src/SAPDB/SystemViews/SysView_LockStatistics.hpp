/*!
  @file           SysView_LockStatistics.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the LOCKSTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_LOCKSTATISTICS_HPP
#define SYSVIEW_LOCKSTATISTICS_HPP
...
/*!
   @class    SysView_LockStatistics
   @brief    This class is used to handle the system table named
             'LOCKSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_LockStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_LockStatistics(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_LOCKSTATISTICS_HPP */
