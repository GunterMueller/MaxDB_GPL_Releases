/*!
  @file           SysView_TaskStatisticsReset.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the TASKSTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_TASKSTATISTICSRESET_HPP
#define SYSVIEW_TASKSTATISTICSRESET_HPP
...
/*!
   @class    SysView_TaskStatisticsReset
   @brief    This class is used to handle the system table named
             'TASKSTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_TaskStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_TaskStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_TASKSTATISTICSRESET_HPP */
