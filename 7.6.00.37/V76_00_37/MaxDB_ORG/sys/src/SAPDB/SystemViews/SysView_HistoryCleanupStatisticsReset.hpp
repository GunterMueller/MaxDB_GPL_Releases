/*!
  @file           SysView_HistoryCleanupStatisticsReset.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the HISTORYCLEANUPSTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_HISTORYCLEANUPSTATISTICSRESET_HPP
#define SYSVIEW_HISTORYCLEANUPSTATISTICSRESET_HPP
...
/*!
   @class    SysView_HistoryCleanupStatisticsReset
   @brief    This class is used to handle the system table named
             'HISTORYCLEANUPSTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_HistoryCleanupStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_HistoryCleanupStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_HISTORYCLEANUPSTATISTICSRESET_HPP */
