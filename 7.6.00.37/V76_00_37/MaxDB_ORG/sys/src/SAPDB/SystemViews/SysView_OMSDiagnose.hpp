/*!
  @file           SysView_OmsDiagnose.hpp
  @author         MarkusSi
  @ingroup        SystemViews
  @brief   This contains a class object representing the OMSDIAGNOSE view.
  @see            
*/
/*
...
#ifndef SYSVIEW_OMSDIAGNOSE_HPP
#define SYSVIEW_OMSDIAGNOSE_HPP
...
/*!
   @class    SysView_OmsDiagnose
   @brief    This class is used to handle the system table named
             'OMSDIAGNOSE'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_OMSDiagnose : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_OMSDiagnose (SQLMan_Context  &context,
