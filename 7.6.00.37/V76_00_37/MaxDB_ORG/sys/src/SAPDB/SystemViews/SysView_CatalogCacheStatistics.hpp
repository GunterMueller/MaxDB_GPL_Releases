/*!
  @file           SysView_CatalogCacheStatistics.hpp
  @author         ThomasA
  @ingroup   SystemViews
  @brief   This contains a class object representing the CATALOGCACHESTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_CATALOGCACHESTATISTICS_HPP
#define SYSVIEW_CATALOGCACHESTATISTICS_HPP
...
/*!
   @class    SysView_CatalogCacheStatistics
   @brief    This class is used to handle the system table named
             'CATALOGCACHESTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */



class SysView_CatalogCacheStatistics : public SysView_SysViewBase
{
public :
     /*-----------------------------------------------------------------------*/
    ...
    /*!
       ...
       @return  none
     */
    SysView_CatalogCacheStatistics(SQLMan_Context  &context,
