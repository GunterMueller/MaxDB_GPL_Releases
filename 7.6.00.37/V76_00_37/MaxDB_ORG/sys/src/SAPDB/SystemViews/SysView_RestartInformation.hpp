/*!
  @file           SysView_RestartInformation.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the RESTARTINFORMATION view.
  @see            
*/
/*
...
#ifndef SYSVIEW_RESTARTINFORMATION_HPP
#define SYSVIEW_RESTARTINFORMATION_HPP
...
/*!
   @class    SysView_RestartInformation
   @brief    This class is used to handle the system table named
             'RESTARTINFORMATION'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_RestartInformation : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_RestartInformation(SQLMan_Context   &context,
...
#endif  /* SYSVIEW_RESTARTINFORMATION_HPP */
