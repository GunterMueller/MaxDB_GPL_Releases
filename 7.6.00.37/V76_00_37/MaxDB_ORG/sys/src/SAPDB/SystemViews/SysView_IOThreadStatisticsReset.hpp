/*!
  @file           SysView_IOThreadStatisticsReset.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the IOTHREADSTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_IOTHREADSTATISTICSRESET_HPP
#define SYSVIEW_IOTHREADSTATISTICSRESET_HPP
...
/*!
   @class    SysView_IOThreadStatisticsReset
   @brief    This class is used to handle the system table named
             'IOTHREADSTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_IOThreadStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_IOThreadStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_IOTHREADSTATISTICSRESET_HPP */
