/*!
  @file           SysView_TaskStatistics.hpp
  @author         ElkeZ
  @ingroup   SystemViews
  @brief   This contains a class object representing the TASKSTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_TASKSTATISTICS_HPP
#define SYSVIEW_TASKSTATISTICS_HPP
...
/*!
   @class    SysView_TaskStatistics
   @brief    This class is used to handle the system table named
             'TASKSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_TaskStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_TaskStatistics(SQLMan_Context   &context,
...
#endif  /* SYSVIEW_TASKSTATISTICS_HPP */
