/*!
  @file           SysView_IOThreadStatistics.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the IOTHREADSTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_IOTHREADSTATISTICS_HPP
#define SYSVIEW_IOTHREADSTATISTICS_HPP
...
/*!
   @class    SysView_IOThreadStatistics
   @brief    This class is used to handle the system table named
             'IOTHREADSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_IOThreadStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_IOThreadStatistics(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_IOTHREADSTATISTICS_HPP */
