/*!
  @file           SysView_OptimizerInformation.hpp
  @author         ElkeZ
  @ingroup   SystemViews
  @brief   This contains a class object representing the OPTIMIZERINFORMATION view.
  @see            
*/
/*
...
#ifndef SYSVIEW_OPTIMIZERINFORMATION_HPP
#define SYSVIEW_OPTIMIZERINFORMATION_HPP
...
/*!
   @class    SysView_OptimizerInformation
   @brief    This class is used to handle the system table named
             'OPTIMIZERINFORMATION'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_OptimizerInformation : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_OptimizerInformation(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_OPTIMIZERINFORMATION_HPP */
