/*!
  @file           SysView_ClassContainers.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the CLASSCONTAINERS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_CLASSCONTAINERS_HPP
#define SYSVIEW_CLASSCONTAINERS_HPP
...
/*!
   @class    SysView_ClassContainers
   @brief    This class is used to handle the system table named
             'CLASSCONTAINERS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_ClassContainers : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_ClassContainers(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_CLASSCONTAINERS_HPP */
