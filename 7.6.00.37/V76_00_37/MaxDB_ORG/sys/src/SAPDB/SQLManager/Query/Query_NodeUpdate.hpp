...
#ifndef Query_NodeUpdate_H
#define Query_NodeUpdate_H
...
// ------------------------------------------------------------------------------------------------
/*!
    @class          Query_UpdateNode
    @brief          Node that represents a UPDATE
    @copydoc        Query_Node
 */
class Query_UpdateNode : public Query_Node
{
protected:    // private copyconstuctor used by CreateDuplicate
    /*!
        ...
        @param  mpQMap  [in]
    */
    Query_UpdateNode( const Query_UpdateNode& N, Query_Node* Father, Query_Quantifier* Q, Query_NodeMapper* mpMap, Query_QuantifierMapper* mpQMap );
public:
    ...
    /*!
        ...
        @param  APNode     [in]
    */
    Query_UpdateNode( Query_ManipulationContext& Context, Query_QueryGraph& QueryGraph, Query_Position Position, SyntaxTreeNodeNo APNode );

    virtual NodeType GetNodeType( void ) { return Update; }
