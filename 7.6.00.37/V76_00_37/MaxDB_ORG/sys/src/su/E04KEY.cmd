*   *ID* E04KEY   DBCMD    changed on 1992-09-28-13.23.44 by ADMIN     *
 ************************ !
 * stack optimization   * !
 * for key conditions   * !
 ************************ !
...
&display
declare erg cursor for select * from t where k1 = '2' for reuse !
fetch erg !
declare erg cursor for select * from t where k1 >= '2' for reuse !
fetch erg !
declare erg cursor for select * from t where k1 <= '2' for reuse !
...
select * from t where k1 between '1' and '2' for reuse !
fetch erg !
declare erg cursor for 
select * from t where k1 >= '2' and k1 <= '3' for reuse !
fetch erg !
declare erg cursor for 
select * from t where k1 <= '2' and k1 <= '3'for reuse !
fetch erg !
declare erg cursor for 
select * from t where k1 like '2%' for reuse !
fetch erg !
declare erg cursor for 
select * from t where k1 between '2' and '4' and k1 <= '3'
for reuse !
fetch erg !
*********************************************************** !
declare erg cursor for select * from t where k1 = '2' and k2 = '2'
for reuse !
fetch erg !
declare erg cursor for select * from t where k1 = '2' and k2 >= '2'
for reuse !
...
fetch erg !
declare erg cursor for 
select * from t where k1 = '2' and k2 between '2' and '3'
for reuse !
fetch erg !
declare erg cursor for 
select * from t where k1 = '2' and k2 >= '2' and k2 <= '3'
for reuse !
fetch erg !
declare erg cursor for 
select * from t where k1 = '2' and k2 like '2%' and k2 <= '3'
for reuse !
fetch erg !
rollback release !
