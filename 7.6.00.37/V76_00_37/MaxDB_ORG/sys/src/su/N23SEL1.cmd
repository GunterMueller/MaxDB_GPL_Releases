*   *ID* N23SEL1  DBCMD    changed on 1992-09-28-13.25.35 by ADMIN     *
file connect ( kern test !
create table tab
   (spalte1 char(64)   ascii key                                       ,
...
select substr(spalte1,1,20), spalte2, spalte3, spalte4, 
       substr(spalte5,1,18) from tab order by spalte1 !
fetch !
select substr(spalte1,1,20), spalte2, spalte6, spalte7, spalte8 from tab
                                             order by spalte1 !
fetch !
commit work release !
