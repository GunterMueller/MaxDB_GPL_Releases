...
SQLRETURN WINAPI pa81SetStrStmtOption( SQLHSTMT     hstmt,
                                       ...
                                       SQLPOINTER   value)
{
    return SQLSetStmtOption( hstmt, option, (SQLROWCOUNT) value );
} /* pa81SetStrStmtOption */
...
SQLRETURN WINAPI pa81SetStrConnectOption( SQLHSTMT     hstmt,
                                          ...
                                          SQLPOINTER   value)
{
    return SQLSetConnectOption( hstmt, option, (SQLROWCOUNT) value );
} /* pa81SetStrStmtOption */
...
SQLRETURN WINAPI pa81GetStrConnectOption( SQLHSTMT     hstmt,
                                          ...
                                          SQLPOINTER   value)
{
    return SQLGetConnectOption( hstmt, option, value );
} /* pa81SetStrStmtOption */
