 ...
 * </xmp>
 */
public class DBMCrash extends TestCase
{
  /**
   * A minimal constructor.Constructor.
   */
  public DBMCrash() throws SQLException, TestDatabaseException
  {
          super();
  } // end DBMCrash
  ...
  public void run()
  {
    ...
    try
    {
      ...
      oDBM.execCmd("dbm_unsinn", DBMUtility.ERR_COMMAND);
      // provocate crash
      oDBM.execCmd("crash", DBMUtility.OK_OK);
      // successfull command
      ...
      oDBM.execCmd("sql_connect nicht,vorhanden", DBMUtility.ERR_SQL);
    }
