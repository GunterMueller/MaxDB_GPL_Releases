 ...
 * description:  DBMServer medium_date command tests
 * version:      7.4.*
 * Copyright (c) 2000-2005 SAP AG
 * -----------------------------------------------------------------------------
 * </xmp>
...
public class MediumDate extends MediumPut
{
  public MediumDate()  throws SQLException, TestDatabaseException
  {
          super();
  }
  /**
  ...
  public void run()
  {
    ...
    try
    {
      ...
      //Too few parameters
      oDBM.execCmd("medium_date",DBMUtility.OK_OK);
      String hallo = oDBM.getAnswer().trim();
      ...
      addMessage(this.toString() + ".run",
                 messageType,
                 "Lenght of timestamp is: " + hallo.length());
    }
