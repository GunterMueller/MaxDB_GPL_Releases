 ...
 * description:  DBMServer param_rmfile command tests
 * version:      7.4.*
 * Copyright (c) 2002-2005 SAP AG
 * -----------------------------------------------------------------------------
 * </xmp>
...
public class ParamRmfile extends BackupState
{
  public ParamRmfile() throws SQLException, TestDatabaseException
  {
    super();
  }
  /**
  ...
  public void run()
  {
    ...
    try
    {
      ...
      oDBM.execCmd("param_rmfile",DBMUtility.ERR_XPSESSION);
