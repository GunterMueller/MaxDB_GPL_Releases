 ...
 * description:  DBMServer param_gettype command tests
 * version:      7.4.*
 * Copyright (c) 2000-2005 SAP AG
 * -----------------------------------------------------------------------------
 * </xmp>
...
public class ParamGetType extends BackupState
{
  private Vector ParamLabel;

  public ParamGetType() throws SQLException, TestDatabaseException
  {
    super();
  ...
  public void run()
  {
    ...
    try
    {
      ...
      oDBM.execCmd("param_gettype MAXDATAVOLUMES",DBMUtility.OK_OK);
