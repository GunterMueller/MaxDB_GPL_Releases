 ...
 * description:  DBMServer param_gethelp command tests
 * version:      7.4.*
 * Copyright (c) 2000-2005 SAP AG
 * -----------------------------------------------------------------------------
 * </xmp>
...
public class ParamGetHelp extends BackupState
{
  private Vector ParamLabel;

  public ParamGetHelp() throws SQLException, TestDatabaseException
  {
    super();

    ParamLabel = new Vector();
    //Expected label (some keywords only) of param_extgetall
    ParamLabel.add("Maximum number of data volumes (including reserve)");
  }
  /**
  ...
  public void run()
  {
    ...
    try
    {
      ...
      oDBM.execCmd("param_gethelp MAXDATAVOLUMES",DBMUtility.OK_OK);
