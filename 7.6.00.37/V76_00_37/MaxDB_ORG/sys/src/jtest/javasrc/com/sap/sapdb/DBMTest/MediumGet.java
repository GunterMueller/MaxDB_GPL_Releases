...
public class MediumGet extends MediumPut
{
  public MediumGet()  throws SQLException, TestDatabaseException
  {
          super();
  }
  /**
  ...
  public void run()
  {
    ...
    try
    {
      ...
      //Too few parameters
      oDBM.execCmd("medium_get",DBMUtility.ERR_TOFEWPARAM);

      //Wrong medium name
      oDBM.execCmd("medium_get a",DBMUtility.ERR_MENOTFOUND);

      //Get medium name
      oDBM.execCmd("medium_get " + NAME,DBMUtility.OK_OK);
    }
