 ...
 * description:  DBMServer param_getvalue command tests
 * version:      7.4.*
 * Copyright (c) 2000-2005 SAP AG
 * -----------------------------------------------------------------------------
 * </xmp>
...
public class ParamGetValue extends BackupState
{
  private Vector ParamLabel;

  public ParamGetValue() throws SQLException, TestDatabaseException
  {
    super();
  ...
  public void run()
  {
    ...
    try
    {
      ...
      oDBM.execCmd("param_getvalue MAXDATAVOLUMES",DBMUtility.OK_OK);
