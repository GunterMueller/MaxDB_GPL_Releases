 ...
 * description:  DBMServer recover_config command tests
 * version:      7.4.*
 * Copyright (c) 2000-2005 SAP AG
 * -----------------------------------------------------------------------------
 * </xmp>
...
public class RecoverConfig extends BackupState
{
  public RecoverConfig() throws SQLException, TestDatabaseException
  {
    super();
  }
  /**
  ...
  public void run()
  {
    ...
    try
    {
      ...
      //Starting Recovery with medium
      oDBM.execCmd("recover_config datamedium",DBMUtility.OK_OK);
      //session release
