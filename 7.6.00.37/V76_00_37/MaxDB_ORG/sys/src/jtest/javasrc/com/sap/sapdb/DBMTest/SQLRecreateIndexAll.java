...
/*!
  -----------------------------------------------------------------------------
  module: SQLRecreateIndexAll.java
  -----------------------------------------------------------------------------
...
public class SQLRecreateIndexAll extends TestCase
{

  public SQLRecreateIndexAll()  throws SQLException, TestDatabaseException
  {
    super();
  }
  /**
  ...
  public void run()
  {
    ...
    try
    {
      ...
      oDBM.execCmd("sql_recreateindex",DBMUtility.OK_OK);
