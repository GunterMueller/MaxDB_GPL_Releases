...
/*LINUX_X86_64*/    }
/*LINUX_X86_64*/}
#    elif defined (LINUX) && defined(IA64) && !defined(HAS_LIBUNWIND_IMPLEMENTATION)
/*LINUX_IA64*/
/*LINUX_IA64*//*---------------------------------------------------------------------------*/
/*LINUX_IA64*/
/*LINUX_IA64*/static void eo670_RegisterDump( void*                 pBTraceContext,
/*LINUX_IA64*/                                OutputCallBackFuncPtr pOutput,
/*LINUX_IA64*/                                void * const          pOutContext )
/*LINUX_IA64*/{
/*LINUX_IA64*/    static ucontext_t *pContext;
/*LINUX_IA64*/    static int iReg;
/*LINUX_IA64*/
/*LINUX_IA64*/    pContext = (ucontext_t *)pBTraceContext;
/*LINUX_IA64*/    eo670WriteOutput( "-----------------------------------------------------\n" , NO_DISPLACEMENT, pOutput, pOutContext);
/*LINUX_IA64*/    sp77sprintf( eo670MessageBuffer,
/*LINUX_IA64*/                 sizeof(eo670MessageBuffer),
/*LINUX_IA64*/                 "for further study...\n" );
/*LINUX_IA64*/    eo670WriteOutput(eo670MessageBuffer, NO_DISPLACEMENT, pOutput, pOutContext);
/*LINUX_IA64*/    eo670WriteOutput( "--------------------------------------------------\n" , NO_DISPLACEMENT, pOutput, pOutContext);
/*LINUX_IA64*/}
/*LINUX_IA64*/
/*LINUX_IA64*//*---------------------------------------------------------------------------*/
/*LINUX_IA64*/
/*LINUX_IA64*/SAPDB_Int4 eo670_FastFillCallArray( SAPDB_Int4            skipCount,
/*LINUX_IA64*/                                    SAPDB_Int4            givenMaxLevel,
/*LINUX_IA64*/                                    void **               callArray,
/*LINUX_IA64*/                                    OutputCallBackFuncPtr pOutput,
/*LINUX_IA64*/                                    void * const          pOutContext )
/*LINUX_IA64*/{
/*LINUX_IA64*/    void *tmpArray[skipCount + givenMaxLevel]; /* gcc extension variable sized array used... */
/*LINUX_IA64*/    int depth = backtrace(tmpArray, skipCount + givenMaxLevel);
/*LINUX_IA64*/    if ( depth > skipCount )
/*LINUX_IA64*/    {
/*LINUX_IA64*/        int iDepth;
/*LINUX_IA64*/        for ( depth -= skipCount, iDepth = 0; iDepth < depth; ++iDepth )
/*LINUX_IA64*/        {
/*LINUX_IA64*/            callArray[iDepth] = tmpArray[iDepth+skipCount];
/*LINUX_IA64*/        }
/*LINUX_IA64*/    }
/*LINUX_IA64*/    else
/*LINUX_IA64*/    {
...
/*LINUX_IA64*/    }
/*LINUX_IA64*/
/*LINUX_IA64*/    return depth;
/*LINUX_IA64*/}
/*LINUX_IA64*/
/*LINUX_IA64*//*---------------------------------------------------------------------------*/
/*LINUX_IA64*/
/*LINUX_IA64*/void eo670_UnixFillCallArray( SAPDB_Int4            skipCount,
/*LINUX_IA64*/                              SAPDB_Int4            maxLevel,
/*LINUX_IA64*/                              SAPDB_Int4 *          pFilledLevel,
/*LINUX_IA64*/                              eo670_CallArrayType   addCallInfo,
/*LINUX_IA64*/                              void **               callArray,
/*LINUX_IA64*/                              void*                 pBTraceContext,
/*LINUX_IA64*/                              OutputCallBackFuncPtr pOutput,
/*LINUX_IA64*/                              void * const          pOutContext )
/*LINUX_IA64*/{
/*LINUX_IA64*/    static int iDepth;
/*LINUX_IA64*/    static int depth;
/*LINUX_IA64*/    static void *tmpCallArray[MAX_STACK+FILL_SKIP_COUNT];
/*LINUX_IA64*/
/*LINUX_IA64*/    *pFilledLevel = 0;
/*LINUX_IA64*/
/*LINUX_IA64*/    for ( iDepth = 1; iDepth <= (skipCount + maxLevel); iDepth++ )
/*LINUX_IA64*/    {
/*LINUX_IA64*/        depth = backtrace(tmpCallArray, skipCount + iDepth);
/*LINUX_IA64*/        if ( depth == (skipCount+iDepth) )
/*LINUX_IA64*/        {
/*LINUX_IA64*/            switch ( addCallInfo )
/*LINUX_IA64*/            {
/*LINUX_IA64*/            case eo670_FullInfoArray:
/*LINUX_IA64*/                ((eo670_CallInfo *)callArray)[*pFilledLevel].pcAddr = tmpCallArray[skipCount+iDepth-1];
/*LINUX_IA64*/                ((eo670_CallInfo *)callArray)[*pFilledLevel].frame  = 0; /* ffs... */
/*LINUX_IA64*/                break;
/*LINUX_IA64*/            case eo670_PointerArray:
/*LINUX_IA64*/                callArray[*pFilledLevel] = tmpCallArray[skipCount+iDepth-1];
/*LINUX_IA64*/                break;
/*LINUX_IA64*/            default: /* eo670_NoArrayJustOutput */
/*LINUX_IA64*/                sp77sprintf( eo670MessageBuffer, sizeof(eo670MessageBuffer),
/*LINUX_IA64*/                         "(%d):0x%lx\n",
/*LINUX_IA64*/                         *pFilledLevel, tmpCallArray[skipCount+iDepth-1]);
/*LINUX_IA64*/                eo670WriteOutput(eo670MessageBuffer, NO_DISPLACEMENT, pOutput, pOutContext);
/*LINUX_IA64*/                break;
/*LINUX_IA64*/            }
/*LINUX_IA64*/            ++*pFilledLevel;
/*LINUX_IA64*/        }
/*LINUX_IA64*/    }
/*LINUX_IA64*/}
#    elif defined(LINUX) && defined(SDBonPPC64)
