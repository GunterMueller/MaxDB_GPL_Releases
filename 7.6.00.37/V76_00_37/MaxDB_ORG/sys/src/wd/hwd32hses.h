...
/* same as sapdbwa_DbConnect but with additional err parameter */
sapdbwa_DbConnectionP wd32DbConnect( sapdbwa_SessionPoolP	pool,
									 twd26ErrP				err	);

/* only allowed for implicitely allocated handles */    
