...
!MESSAGE No configuration specified. Defaulting to expat_static - Win32 Debug.
!ENDIF 
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O2 /D "WIN32" /D "_WINDOWS" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "COMPILED_FROM_DSP" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /Wp64 /c 
