 ...
 *
 * astyle_main.cpp   (11 February 2000)
...
bool parseOption(ASFormatter &formatter, const string &arg, const string &errorInfo)
{
    ...
    else if (IS_OPTION(arg, "frame-skip"))
    {
        formatter.setSkipModulFrame(true);
    }
...
void printHelp()
{
    ...
    (*_err) << endl;
    (*_err) << "By default, astyle is set up to indent C/C++  files, with 4 spaces per\n" ;
