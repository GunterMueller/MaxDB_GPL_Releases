...
TYPE
      ...
      ak641stackentries = PACKED ARRAY [0..256] OF tsp_int2;
...
VAR
      ...
      FUNCTION
              a12dbfunc_exist (VAR acv : tak_all_command_glob;
                    VAR method_name : tsp_knl_identifier;
        ...
        FUNCTION
              a12exist_type (VAR acv : tak_all_command_glob;
                    ...
                    VAR type_name : tsp_knl_identifier;
        ...
        PROCEDURE
              a12get_domain (
                    VAR acv         : tak_all_command_glob;
                    VAR owner       : tsp_knl_identifier;
                    VAR domain_name : tsp_knl_identifier;
                    ti              : integer;
      ...
      PROCEDURE
              a16inc_vdesc_cnt (VAR acv : tak_all_command_glob;
      ...
      FUNCTION
              a23exist_sequence (
                    ...
                    VAR seq_owner : tsp_knl_identifier;
                    VAR seq_name  : tsp_knl_identifier) : boolean;
        EXTERNAL ;



      PROCEDURE
              a61_search_table (VAR acv : tak_all_command_glob;
                    VAR dmli : tak_dml_info);
        EXTERNAL ;
        ...
        PROCEDURE
              a61_rel_old_table (VAR acv : tak_all_command_glob;
                    VAR dmli : tak_dml_info;
                    i        : integer);
        EXTERNAL ;
      ...
      PROCEDURE
              a640factor (VAR acv : tak_all_command_glob;
                    VAR dmli     : tak_dml_info;
        ...
        PROCEDURE
              a640not_first_factor (VAR acv : tak_all_command_glob;
                    VAR dmli     : tak_dml_info;
                    VAR colin    : tak00_scolinf;
                    VAR act_node : integer);
        EXTERNAL ;
      ...
      PROCEDURE
              a642other_than_column (VAR acv : tak_all_command_glob;
                    VAR dmli  : tak_dml_info;
      ...
      PROCEDURE
              a65_look_for_datatypes (VAR acv : tak_all_command_glob;
                    VAR dmli   : tak_dml_info;
                    first_node : integer);
        EXTERNAL ;
        ...
        PROCEDURE
              a65ch_format (VAR acv : tak_all_command_glob;
                    VAR dmli       : tak_dml_info;
        ...
        FUNCTION
              a65_datatypes_ok (VAR acv : tak_all_command_glob;
                    VAR dmli       : tak_dml_info;
      ...
      PROCEDURE
              g02tebcdic_to_ascii (VAR source : char;
                    VAR dest : char;
                    length   : tsp_int4);
        EXTERNAL ;
        ...
        PROCEDURE
              g02tascii_to_ebcdic (VAR source : char;
                    VAR dest : char;
                    length   : tsp_int4);
        EXTERNAL ;
      ...
      PROCEDURE
        ...
        PROCEDURE
              g10mv1 (mod_id   : tsp_c6;      mod_intern_num : tsp_int4;
                    source_upb : tsp_int4;    destin_upb     : tsp_int4;
                    VAR source : tak_map_set; source_pos     : tsp_int4;
                    VAR destin : tsp_moveobj; destin_pos : tsp_int4;
                    length     : tsp_int4;    VAR e : tgg_basis_error);
        EXTERNAL ;



        PROCEDURE
              g10mv2 (mod_id   : tsp_c6;      mod_intern_num : tsp_int4;
                    source_upb : tsp_int4;    destin_upb     : tsp_int4;
                    VAR source : tsp_moveobj; source_pos     : tsp_int4;
                    VAR destin : tsp_knl_identifier; destin_pos : tsp_int4;
                    length     : tsp_int4;    VAR e : tgg_basis_error);
        EXTERNAL ;
        ...
        PROCEDURE
              g10mv4 (mod_id   : tsp_c6;      mod_intern_num : tsp_int4;
                    source_upb : tsp_int4;    destin_upb     : tsp_int4;
                    VAR source : tsp_c3;      source_pos     : tsp_int4;
                    VAR destin : tsp_moveobj; destin_pos     : tsp_int4;
                    length     : tsp_int4;    VAR e : tgg_basis_error);
        EXTERNAL ;
        ...
        PROCEDURE
              g10mv5 (mod_id   : tsp_c6;      mod_intern_num : tsp_int4;
                    source_upb : tsp_int4;    destin_upb     : tsp_int4;
                    VAR source : tsp_knl_identifier; source_pos : tsp_int4;
                    VAR destin : tsp_moveobj; destin_pos     : tsp_int4;
                    length     : tsp_int4;    VAR e : tgg_basis_error);
        EXTERNAL ;
        ...
        PROCEDURE
              g10mv6 (mod_id   : tsp_c6;      mod_intern_num : tsp_int4;
                    source_upb : tsp_int4;    destin_upb     : tsp_int4;
                    VAR source : tgg_dbfunc_info; source_pos : tsp_int4;
                    VAR destin : tsp_moveobj; destin_pos     : tsp_int4;
                    length     : tsp_int4;    VAR e : tgg_basis_error);
        EXTERNAL ;
        ...
        PROCEDURE
              g10mv7 (mod_id   : tsp_c6;      mod_intern_num : tsp_int4;
                    source_upb : tsp_int4;    destin_upb     : tsp_int4;
                    VAR source : tsp_c50;     source_pos     : tsp_int4;
                    VAR destin : tsp_moveobj; destin_pos     : tsp_int4;
                    length     : tsp_int4;    VAR e : tgg_basis_error);
        EXTERNAL ;
      ...
      PROCEDURE
              g20get_uni_key (VAR setname : tsp_knl_identifier;
        ...
        PROCEDURE
              g20get_uni_set (messcode  : tsp_code_type;
                    VAR codewidth : tsp00_Uint1;
      ...
      FUNCTION
              k79n_dest_len_ora_number_format (VAR format : tsp_moveobj;
                    fmt_pos : tsp_int4;
                    fmt_len : tsp_int4) : tsp_int2;
        EXTERNAL ;



      FUNCTION
              s78t_dest_len_date_format (VAR format : tsp_moveobj;
                    fmt_pos : tsp_int4;
                    fmt_len : tsp_int4) : tsp_int2;
        EXTERNAL ;
      ...
      PROCEDURE
        ...
        FUNCTION
              s30lnr_defbyte (str : tsp_knl_identifier_ptr;
                    defbyte   : char;
                    start_pos : tsp_int4;
...
PROCEDURE
      ak641addsubdate (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641addsubtime (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer;
...
PROCEDURE
      ak641ascii (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641_add_months (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641new_time (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      a641add_mapchar (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            VAR setname        : tsp_knl_identifier;
            curr_n             : integer;
...
PROCEDURE
      a641get_mapcharset (VAR acv : tak_all_command_glob;
            VAR mapcharsetname : tsp_knl_identifier;
            error_pos          : integer;
...
PROCEDURE
      ak641mapchar (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641char (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641mbcs (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer);
        FORWARD;
...
PROCEDURE
      ak641check_datatype (VAR acv : tak_all_command_glob;
            VAR colin          : tak00_scolinf;
...
PROCEDURE
      ak641chr (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            act_node           : integer;
            VAR colin          : tak00_scolinf;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641chr_ora ( VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641concat ( VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641conversion (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641datediff (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641datetime (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641days (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641digits (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer);
        FORWARD;
...
PROCEDURE
      ak641expand ( VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641space ( VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641fixed_float ( VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            symb      : tak_sc_symbol;
            act_node  : integer);
...
PROCEDURE
      ak641float ( VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      a641_get_length ( VAR colin : tak00_scolinf;
            VAR output_length     : tsp_int2;
            VAR wrong_datatype    : boolean);
        FORWARD;

PROCEDURE
      ak641_hextoraw (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641hex (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641index (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641last_day (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641length_vsize (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
...
PROCEDURE
      ak641to_char (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer);
        FORWARD;
...
PROCEDURE
      ak641toidentifier (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer);
        FORWARD;
...
PROCEDURE
      a641l_push_language (VAR acv : tak_all_command_glob;
            VAR dmli : tak_dml_info);
        FORWARD;

PROCEDURE
      ak641s_push_string (VAR acv : tak_all_command_glob;
            dtyp          : tsp_data_type;
            tree_index    : integer;
...
PROCEDURE
      ak641push_blank (VAR acv : tak_all_command_glob;
            dtyp  : tsp_data_type );
        FORWARD;

PROCEDURE
      a641f_push_format (VAR acv : tak_all_command_glob;
            VAR dmli : tak_dml_info);
        FORWARD;

PROCEDURE
      a641d_push_date (VAR acv : tak_all_command_glob;
            VAR dmli : tak_dml_info);
        FORWARD;

PROCEDURE
      a641translate_string_literal (VAR letter : char;
            VAR keep_datatype : tsp_data_type);
        FORWARD;

PROCEDURE
      ak641time_date_to_char_datatype
            (VAR erg_datatype  : tsp_data_type;
            VAR keep_datatype : tsp_data_type);
        FORWARD;

PROCEDURE
      a641s_literal_value ( VAR acv : tak_all_command_glob;
            act_node           : integer;
...
PROCEDURE
      a641u_literal_value (VAR acv : tak_all_command_glob;
            act_node           : integer;
            VAR c2             : tsp_c2;
            VAR wrong_datatype : boolean);
        FORWARD;
...
PROCEDURE
      ak641lrpad (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641to_date (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641replace_translate (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641trim (VAR acv       : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641makedate (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641maketime (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641months_between (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer);
        FORWARD;
...
PROCEDURE
      ak641noround (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer);
        FORWARD;
...
PROCEDURE
      ak641num (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641name (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer);
        FORWARD;
...
PROCEDURE
      ak641of (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641put_maxlength (VAR acv : tak_all_command_glob;
            VAR curr_n     : integer;
            symb           : tak_sc_symbol;
            VAR first_int  : tsp_int2;
            VAR second_int : tsp_int2);
        FORWARD;

PROCEDURE
      ak641put_roundlength (VAR acv : tak_all_command_glob;
            VAR curr_n     : integer;
            VAR colin      : tak00_scolinf);
        FORWARD;

PROCEDURE
      ak641soundex (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641substr (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641leftright (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer;
            symbol    : tak_sc_symbol);
...
PROCEDURE
      ak641timedate (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641timediff (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641not_first_type_or_timestamp_parameter
            ...
            VAR colin    : tak00_scolinf;
            VAR act_node : integer;
            wanted_type  : tsp_data_type);
        FORWARD;

PROCEDURE
      ak641type_or_timestamp_parameter (VAR acv : tak_all_command_glob;
            VAR dmli     : tak_dml_info;
            VAR colin    : tak00_scolinf;
            VAR act_node : integer;
            wanted_type  : tsp_data_type);
...
PROCEDURE
      ak641timestamp (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR frec  : tak_factorrec;
            VAR colin : tak00_scolinf;
            act_node  : integer;
...
PROCEDURE
      ak641truncround (VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            act_node           : integer;
            VAR wrong_datatype : boolean);
...
PROCEDURE
      ak641mod_power (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641integer (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641newcolin(VAR colin  : tak00_scolinf;
            VAR colin1 : tak00_scolinf);
        FORWARD;
...
FUNCTION
      ak641unicode_conv_destroyed (mb_st : tgg00_StackListPtr;
            VAR stackentries : ak641stackentries;
            pair_cnt         : tsp_int2) : boolean;
        FORWARD;

FUNCTION
      ak641destroy_dummy_entries (mb_st : tgg00_StackListPtr;
            start_st : tsp_int2;
            stop_st  : tsp_int2) : integer;
        FORWARD;

PROCEDURE
      ak641decode_func (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641special_colin (VAR colin : tak00_scolinf;
            max_integer   : tsp_int2;
            max_sci_frac  : tsp_int2);
        FORWARD;

PROCEDURE
      ak641special_func (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      a641check_datetime(VAR acv : tak_all_command_glob;
            VAR dmli : tak_dml_info;
            datatyp  : tsp_data_type);
        FORWARD;
...
PROCEDURE
      ak641get_name (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      a641col_function (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR frec  : tak_factorrec;
            VAR colin : tak00_scolinf;
            act_node  : integer);
...
PROCEDURE
      a641stack_for_op_b_chr ( VAR acv : tak_all_command_glob;
            VAR dmli           : tak_dml_info;
            VAR colin          : tak00_scolinf;
            first_int          : tsp_int2;
            keep_datatype      : tsp_data_type);
...
PROCEDURE
      a641string_set_operator (VAR acv : tak_all_command_glob;
...
PROCEDURE
      a641dbyte_string_set_operator (VAR acv : tak_all_command_glob;
            operator     : tgg_stack_op_build_in;
            destlength   : integer;
            sourcelength : integer;
            c2           : tsp_c2);
...
PROCEDURE
      ak641user_defined_func (VAR acv : tak_all_command_glob;
            VAR dmli  : tak_dml_info;
            VAR colin : tak00_scolinf;
            act_node  : integer);
        FORWARD;
...
PROCEDURE
      ak641describe_output_param (VAR acv : tak_all_command_glob;
            VAR dmli      : tak_dml_info;
...
PROCEDURE
      ak641describe_param  (VAR acv : tak_all_command_glob;
            VAR dmli      : tak_dml_info;
            proc_buf      : tak_sysbufferaddress;
            param_no      : integer;
            VAR scolinf   : tak00_scolinf;
...
PROCEDURE
      ak641emit_param (VAR acv : tak_all_command_glob;
            VAR dmli        : tak_dml_info;
            proc_buf        : tak_sysbufferaddress;
            is_in_out_param : boolean;
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    BEGIN
    curr_n := n_lo_level;
    ak641type_or_timestamp_parameter (acv, dmli, colin, curr_n, ddate);
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    BEGIN
    curr_n       := n_lo_level;
    ak641type_or_timestamp_parameter (acv, dmli, colin, curr_n, dtime);
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    THEN
        ...
        IF  (n_symb = s_next_day) AND
            (a_return_segm^.sp1r_returncode = cak_e_parameter)
        THEN
            BEGIN
            a_return_segm^.sp1r_returncode := 0;
            d_datatype  := dnonumber;
...
WITH acv, dmli DO
    ...
    THEN (* Build up the rules according to the mapchar_set in part2 *)
        WITH a_mblock, mb_data^, sbuf^, smapset DO
            IF  (mb_data_len + 3 * map_count + 1) > mb_data_size
            THEN
            ...
            ELSE
                ...
                THEN
                    ...
                    univ_ptr.mapsetptr := @map_set;
                    s30map (g02codetables.tables[ cgg_to_ascii ],
                          univ_ptr.moveobjptr^, 1,
                    ...
                    ELSE
                        ...
                        THEN
                            ...
                            mbp_buf[ curr_data_pos ] :=
                                  csp_ebcdic_blank;
                            univ_ptr.mapsetptr := @map_set;
                            s30map (g02codetables.tables
                                  [ cgg_to_ebcdic ], univ_ptr.moveobjptr^, 1,
                                  mbp_buf, curr_data_pos + 1,
                                  3 * map_count)
                            END
                        ELSE
                ...
                THEN
                    ...
                    WITH mb_qual^ DO
                        ...
                        (*ENDIF*)
                    (*ENDWITH*)
                    mb_data_len := mb_data_len + 3 * map_count;
                    IF  a_cmd_segm^.sp1c_mess_type = sp1m_parse
                    THEN
                        d_movebefore := d_movebefore +
                              csp_attr_byte + 3 * map_count;
                    (*ENDIF*)
                    END
                (*ENDIF*)
                END;
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    IF  (a_return_segm^.sp1r_returncode = 0)
    THEN
        IF  ((colin.sci_typ = dchb)         OR
            ( colin.sci_typ = ddbyteebcdic) OR
        ...
        ELSE
            ...
            THEN
                ...
                IF  ((first_int < 1) OR (first_int > cak_maxadabasfieldlength))
                THEN
                ...
                END
            ELSE
                IF  (d_wherepart OR (a_sqlmode = sqlm_oracle)) (* nlssort *)
                THEN
                    IF  first_int <= 10
                    THEN
                    ...
                    ELSE
                        ...
                        ELSE
                            ...
                            ELSE
                                ...
                                THEN
                                    BEGIN
                                    IF  first_int > cak_maxorafieldlength
                                    THEN
                                        first_int := cak_maxorafieldlength
                                    (*ENDIF*)
                                    END
                                ELSE
                                    IF  first_int > cak_maxadabasfieldlength
                                    THEN
                                        first_int := cak_maxadabasfieldlength;
                                    (*ENDIF*)
                                (*ENDIF*)
                                END;
                            (*ENDIF*)
            ...
            THEN
                ...
                END
            ELSE
                a061assign_colname (cgg_default_mapchar_set, setname);
            (*ENDIF*)
            a641add_mapchar (acv,
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    IF  NOT (d_datatype in [ dunknown, dnonumber, dcha, dche,
        (* PTS 1109069 E.Z. *)
        dunicode,
    ...
    ELSE
        ...
        IF  (a_return_segm^.sp1r_returncode = cak_e_parameter) AND
            (d_datatype <> dfixed)
        THEN
            (* PTS 1109261 E.Z. *)
            BEGIN
    ...
    THEN
        ...
        ELSE
            IF  (messcode = csp_unicode) AND
                (a_in_packet^.sp1_header.sp1h_mess_swap <> sw_normal)
            THEN
...
CASE colin.sci_typ OF
    dtime, ddate, dtimestamp :
        BEGIN
        IF  NOT (colin1.sci_typ in [ dcha, dche, ddate, dtime, dtimestamp ])
        THEN
            wrong_datatype := true;
        (*ENDIF*)
        ...
        END;
    dche :
        IF  NOT (colin1.sci_typ in [ dcha, dche, dtime, ddate, dtimestamp ])
        THEN
            wrong_datatype := true;
        (*ENDIF*)
    dcha :
        IF  NOT (colin1.sci_typ in [ dcha, dche,
            dtime, ddate, dtimestamp ])
        THEN
    ...
    dunicode :
        IF  colin1.sci_typ <> colin.sci_typ
        THEN
            IF  colin1.sci_typ in [ dcha, dche ]
            THEN
                BEGIN
                IF  colin1.sci_typ = dche
                THEN
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    IF  a_return_segm^.sp1r_returncode = 0
    THEN
        IF  (colin.sci_typ = ddbyteebcdic)
            OR
            (((keep_datatype <> dunicode) AND (keep_datatype <> dunknown)) AND
            (colin.sci_typ = dunicode))
            OR
            ( (keep_datatype = dchb) AND (colin.sci_typ <> dchb))
            OR
            (((keep_datatype <> dchb) AND (keep_datatype <> dunknown)) AND
            (colin.sci_typ = dchb))
            OR
            ((a_sqlmode = sqlm_oracle) AND (d_datatype in [ dcha, dche ]))
        THEN
            wrong_datatype := true
        ELSE
            BEGIN
            ...
            THEN
                ...
                IF  (
                    (first_int < 1)                              OR
                    (first_int > cak_maxadabasfieldlength)       OR
                    ((2*first_int > cak_maxadabasfieldlength) AND
                    ( d_datatype = dunicode))
                    )
                THEN
                    a07_b_put_error (acv, e_invalid_datalength,
    ...
    THEN
        ...
        THEN
            ...
            CASE a_sqlmode OF
                ...
                sqlm_adabas :
                    max_length := cak_maxadabasfieldlength;
                OTHERWISE
            ...
            THEN
                ...
                IF  (colin.sci_iolen > max_length+1)
                THEN
                    BEGIN
            ...
            ELSE
                BEGIN
                IF  (colin.sci_typ = ddbyteebcdic) OR
                    (colin.sci_typ = dunicode)
                THEN
    ...
    ELSE
        ...
        THEN
            ...
            CASE n_symb OF
                ...
                s_ebcdic :
                    BEGIN
                    IF  NOT (colin.sci_typ in [ dcha, dche, dunicode,
                        ddate, dtime, dtimestamp ])
                    THEN
                        wrong_datatype := true
                    ELSE
                        ...
                        ELSE
                            BEGIN
                            IF  colin.sci_typ in [ dcha,ddate,dtime,dtimestamp ]
                                (* Only if a an EBCDIC-field is there *)
                ...
                s_ascii :
                    ...
                    ELSE
                        ...
                        THEN
                            ...
                            END
                        ELSE
                            IF  colin.sci_typ in [ dche, ddate, dtime,
                                dtimestamp ]
                                (* Only if a an EBCDIC-field is there *)
                                (* a conversion is necessary       *)
                            THEN
                                IF  (g01code.ctype = csp_ebcdic) OR
                                    (colin.sci_typ = dche)
                                THEN
                                    a65_set_operator (acv, op_ascii);
                                (*ENDIF*)
...
WITH acv, a_ap_tree^[ act_node ], dmli, colin DO
    ...
    THEN
        BEGIN
        IF  NOT (d_datatype in [ dche, dcha, dunicode, dunknown ])
        THEN
            wrong_datatype := true
        ELSE
            BEGIN
...
WITH colin DO
    CASE sci_typ OF
        dcha, dche, ddate, dtime, dtimestamp, dunicode:
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    IF  (a_return_segm^.sp1r_returncode = 0)
    THEN
        IF  NOT (d_datatype in [ dcha, dche, dunicode ])
        THEN
            wrong_datatype := true
        ELSE
            BEGIN
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    THEN
        ...
        (*ENDCASE*)
        (* PTS 1000311 E.Z. *)
        IF  colin.sci_typ in [ dcha, dche, dchb,
            ddate, dtime, dtimestamp ]
        THEN
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    ELSE
        ...
        THEN
            ...
            THEN
                a07_b_put_error (acv, e_parameter_not_allowed, n_pos)
            ELSE
                BEGIN
                a640not_first_factor (acv, dmli, colin1, curr_n);
                IF  a_return_segm^.sp1r_returncode = 0
                        ...
                        THEN
                            ...
                            THEN
                                WITH a_mblock, mb_qual^ DO
                                    BEGIN
                                    index := mfirst_free - 1;
                                    s40gsint (a_mblock.mb_data^.mbp_buf,
                                          mb_st^ [index].epos + 1,
                                          (mb_st^ [index].elen_var - 1 - csp_attr_byte) * 2,
                                          start, n_err);
                                    IF  n_err = num_ok
                                    THEN
                                        IF  ((start < 1)
    ...
    THEN
        ...
        THEN (* call of TO_CHAR with number. *)
            ...
            ELSE
                ...
                THEN
                    ...
                    END;
                (*ENDIF*)
                IF  colin2.sci_typ in [ dcha, dche, dunknown ]
                THEN (* string column, string constant or null *)
                    WITH a_ap_tree^[ curr_n ] DO
                        IF  n_symb = s_string_literal
                        THEN (* observe the given format string. *)
                            WITH a_mblock, mb_qual^ DO
                                max_length := k79n_dest_len_ora_number_format(
                                      mb_data^.mbp_buf,
                                      mb_st^ [mfirst_free-1].epos+1,
                                      mb_st^ [mfirst_free-1].elen_var-1)
                            (*ENDWITH*)
                        ELSE (* reasonable maximum. *)
                            max_length := cgg_oradate_max_to_char
                        (*ENDIF*)
                    (*ENDWITH*)
                ELSE
        ...
        ELSE
            ...
            THEN (* it's the simple format YYYYMMDDHH24MISS. *)
                BEGIN
                max_length := cgg_oradate_len_to_char;
        ...
        (*ENDIF*)
    (*ENDIF*)
    IF  (a_return_segm^.sp1r_returncode = 0) AND (n_symb <> s_to_24_char)
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    THEN
        ...
        colin.sci_frac  := 0;
        colin.sci_iolen := colin.sci_len + 1;
        IF  colin.sci_iolen > cak_maxadabasfieldlength
        THEN
            a07_b_put_error (acv, e_one_output_field_too_long,
                  a_ap_tree^[ act_node ].n_pos);
        (*ENDIF*)
...
BEGIN
cccprint('AK641 a641l_push'); (* put a_ak_language (or nls_date_language) onto the stack. *)
        ...
        THEN
            ...
            THEN
                g10mv4 ('VAK641',   5,
                      ...
                      mxsp_c3, a_return_segm^.sp1r_returncode)
            ELSE
                g10mv4 ('VAK641',   6,
...
BEGIN
cccprint('AK641 a641f_push'); (* now we put a_nls_params.date_format onto the stack. *)
WITH acv, a_mblock, mb_data^, mb_qual^ DO
    BEGIN
    curr_data_pos := mb_data_len + 1;
    IF  dmli.d_view
...
BEGIN
cccprint('AK641 a641d_push'); (* now we put the current date on the stack.             *)
...
IF  ((keep_datatype = dcha)
    AND (g01code.ctype <> csp_ascii))
THEN
    g02tebcdic_to_ascii (letter, letter, 1)
ELSE
    IF  ((keep_datatype = dche)
        AND (g01code.ctype <> csp_ebcdic))
    THEN
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    char_field_found :=  a_ap_tree^[ curr_n ].n_symb IN
          [ s_authid, s_tablename, s_columnname, s_null ];
    a640factor (acv, dmli, colin, curr_n);
    IF  d_datatype = ddbyteebcdic
    THEN
        wrong_datatype := true
    ELSE
        ...
        THEN
            ...
            (*ENDIF*)
            keep_datatype := d_datatype;
            IF  (NOT (d_datatype in [ dcha, dche, dchb, dunicode ])) OR
                (d_ch_datatype <> dunknown)
            THEN
                    ...
                    THEN
                        ...
                        THEN
                            ...
                            CASE n_symb OF
                                ...
                                END;
                            (*ENDCASE*)
                            a641dbyte_string_set_operator (acv,
        ...
        THEN
            ...
            THEN
                ...
                THEN
                    ...
                    END;
                (*ENDIF*)
                IF  NOT (colin.sci_typ in [ dcha, dche, dunknown ])
                THEN (* string column, string constant or null *)
                    a07_b_put_error (acv, e_incompatible_datatypes,
                          a_ap_tree^[ curr_n ].n_pos)
                (*ENDIF*)
            ...
            THEN
                ...
                THEN (* Push a_nls_params.date_format onto stack. *)
                    ...
                    END;
                (*ENDIF*)
                a641d_push_date     (acv, dmli); (* Push current date and   *)
        ...
        THEN
            ...
            THEN
                ...
                CASE a_sqlmode OF
                    ...
                    END;
                (*ENDCASE*)
                IF  (colin.sci_len > max_length)    OR
                    ((colin.sci_typ = dunicode) AND
                    (2 * colin.sci_len > max_length))
                THEN
                    a07_b_put_error (acv, e_one_output_field_too_long,
                          a_ap_tree^[ act_node ].n_pos);
                (*ENDIF*)
...
VAR
      ...
      curr_n           : integer;
      para_count       : integer;
      build_in_func    : tgg_stack_op_build_in;
      res_len          : tsp_int2;
      old_sci_len      : tsp_int2;
...
WITH acv, a_ap_tree^[ act_node ], dmli, colin DO
    ...
    IF  (a_return_segm^.sp1r_returncode = 0)
    THEN
        IF  (d_datatype IN [ dchb, ddbyteebcdic])
        THEN
            wrong_datatype := true
        ELSE
            BEGIN
            ...
            THEN
                ...
                END;
            (*ENDIF*)
            IF  ((a_return_segm^.sp1r_returncode = 0) AND NOT wrong_datatype)
            THEN
                BEGIN
                ...
                ELSE
                    ...
                    old_sci_len := 0;
                (*ENDIF*)
                IF  (colin.sci_typ IN [ dcha, dche, dunicode ])
                THEN
                    d_datatype := sci_typ
                ELSE
                    IF  (g01code.ctype = csp_ascii)
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    THEN
        BEGIN
        (* 'a_return_segm^.sp1r_returncode' ='par_error' is true, if a      *)
    ...
    THEN
        IF  ((n_symb = s_num) AND
            (d_datatype in [ ddbyteebcdic, dchb ])) OR
            ((n_symb = s_to_number) AND
            (d_datatype <> dcha) AND
            (d_datatype <> dche) AND
            (d_datatype <> dunicode))
        THEN
        ...
        ELSE
            ...
            ELSE
                ...
                (* version takes place                         *)
                IF  d_datatype in [  dcha, ddate, dtime,
                    dtimestamp ]
                THEN
                    BEGIN
                    IF  g01code.ctype = csp_ebcdic
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    THEN
        ...
        THEN
                    ...
                    WITH a_mblock, mb_qual^ DO
                        ...
                        THEN
                            IF  (second_int <= 0)
                                ...
                                OR
                                (((keep_datatype = ddbyteebcdic) OR
                                (  keep_datatype = dunicode))         AND
            ...
            THEN
                BEGIN
                IF  (keep_datatype = ddbyteebcdic) OR
                    (keep_datatype = dunicode)
                THEN
                    BEGIN
                ...
                THEN
                    a641string_set_operator (acv, op,
                          second_int, colin.sci_len, chr(2), chr(0))
                ELSE
                    a641string_set_operator (acv, op,
                          second_int, colin.sci_len, chr(3), chr(0));
                (*ENDIF*)
                IF  op = op_b_substr
                THEN
                    BEGIN
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    THEN
        ...
        THEN
            BEGIN
            IF  keep_datatype in [ dunicode, ddbyteebcdic ]
            THEN
                BEGIN
                first_int := 2*first_int;
                colin.sci_len := 2*colin.sci_len;
...
WITH acv, a_ap_tree^[ act_node ], dmli,
    ...
    THEN
        WITH colin DO
            IF  sci_typ in [ ddbyteebcdic, dchb ]
            THEN
                wrong_datatype := true
            ELSE
                IF  n_symb = s_func_date
                THEN
                    ...
                    ELSE
                        BEGIN
                        IF  sci_typ in [ dcha, dche, dunicode ]
                        THEN
                            a641check_datetime(acv, dmli, ddate)
                        ELSE
    ...
    THEN
        ...
        THEN
            ...
            THEN
                ...
                d_datatype      := dcha;
                a640not_first_factor (acv, dmli, colin1, curr_n);
                IF  (d_datatype <> dcha) AND (d_datatype <> dche)
                THEN
                    wrong_datatype := true
                ELSE
                    BEGIN
...
BEGIN
cccprint('AK641 ak641newco'); (* PTS 1113810 *)
t01int4 (ak_sem, 'colin  typ  ', ord(colin.sci_typ));
...
VAR
      ...
      value_cnt       : integer;
      colin1          : tak00_scolinf;
      search_datatype : tsp_data_type;
      result_datatype : tsp_data_type;
      ch_type         : tsp_data_type;
      ch1_type        : tsp_data_type;
...
WITH acv, a_ap_tree^[ act_node ], dmli, a_mblock, mb_qual^ DO
    ...
    THEN
        ...
        WHILE ( a_ap_tree^[ curr_n ].n_sa_level <> 0 )
              AND ( a_return_segm^.sp1r_returncode = 0 ) DO
            BEGIN
            ...
            THEN (* default expression *)
                ...
                (*ENDIF*)
                IF  (result_datatype = dunknown) AND
                    (d_datatype <> dunknown)
                THEN
                    result_datatype := d_datatype;
                (*ENDIF*)
...
VAR
      ...
      last_node        : tsp_int2;
      err_char_no      : tsp_int4;
      temp_cmd_len     : tsp_int4;
      i_buf_len        : tsp_int4;
      auth_node        : integer;
      uni_err          : tsp8_uni_error;
      temp_cmd_ptr     : tsp1_part_ptr;
      scvh             : tak_scanner_glob;
      authid           : tsp_knl_identifier;
      object_ident     : tsp_knl_identifier;
...
WITH acv DO
    ...
    THEN
        ...
        CASE chr(objecttype) OF
            ...
            cak_cdomain :
                ...
                ELSE
                    IF  a_return_segm^.sp1r_returncode =
                        a07_return_code (e_unknown_domainname, a_sqlmode)
                    THEN
                        BEGIN
                        a_return_segm^.sp1r_returncode := 0;
            ...
            cak_csequence :
                BEGIN
                IF  a23exist_sequence (acv, put_node, sys_buf, authid, object_ident)
                THEN
                    ok := true
                ELSE
                    IF  a_return_segm^.sp1r_returncode =
                        a07_return_code (e_unknown_sequencename, a_sqlmode)
                    THEN
                        BEGIN
                        a_return_segm^.sp1r_returncode := 0;
                        a_return_segm^.sp1r_errorpos   := 0;
...
WITH acv, a_ap_tree^[ act_node ], dmli DO
    ...
    (*ENDIF*)
    curr_n := n_lo_level;
    colin.sci_len   := sizeof (tsp_knl_identifier) DIV 2;
    colin.sci_frac  := 0;
    colin.sci_typ   := d_datatype;
    ...
    THEN
        ...
        a641_get_name (acv, a_cmd_part,
              ...
              (n_symb = s_get_owner), n_subproc, returned_name);
        IF  a_return_segm^.sp1r_returncode = 0
        THEN
...
WITH acv, a_ap_tree^[ act_node ], dmli, frec DO
    ...
    CASE n_symb OF
        ...
        s_chr :
            IF  ((d_datatype = dnumber) OR (d_datatype = ddbyteebcdic))
            THEN
                fr_error := true
            ELSE
        ...
        s_func_time ,
        s_func_timestamp :
            IF  (d_datatype in [ dunknown, dnonumber, dcha, dche ]) OR
        ...
        s_hex :
            ...
            (*ENDIF*)
        s_hextoraw :
            IF  (d_datatype <> dcha) AND (d_datatype <> dche) AND
                (d_datatype <> dunknown)
            THEN
                fr_error := true
            ELSE
        ...
        s_mapchar :
            ...
            (*ENDIF*)
        s_mbcs :
            IF  ((d_datatype <> dchb) AND (d_datatype <> dunknown))
            THEN
                fr_error := true
            ELSE
        ...
        s_ascii :
            ...
            (*ENDIF*)
        s_ebcdic, s_upper, s_lower, s_initcap, s_unicode:
            IF  (d_datatype = dnumber) OR
                (d_datatype = ddbyteebcdic) OR
                (d_datatype = dchb)
            THEN
    ...
    CASE n_symb OF
        ...
        s_ascii, s_ebcdic, s_upper, s_lower, s_initcap, s_trim, s_rtrim,
...
VAR
      ...
      proc_buf        : tak_sysbufferaddress;
      func_info       : tgg_dbfunc_info;
      param_info      : ARRAY[1..16] OF tak00_scolinf;
...
WITH acv, dmli DO
    ...
    proc_buf          := NIL;
    is_in_out         := 0;
    is_method_call    := a_ap_tree^[act_node].n_symb = s_method_call;
    ...
    THEN
        ...
        IF  d_pseudo_ins_select
        THEN
            BEGIN
            d_tabarr[3]   := d_tabarr[1]; (* save table DUAL *)
            d_tabarr[1]   := d_tabarr[2]; (* INSERT table    *)
            d_acttabindex := 0;
        ...
        THEN
            BEGIN
            type_id.surrogate := cgg_zero_id;
            type_id.type_flag := cak_type_site;
            type_id.id        := dmli.d_colbuf^.cudtdatatype;
            IF  a12method_exist (acv,
                type_id.surrogate, func_name, d_release, proc_buf)
            THEN ;
            (*ENDIF*)
            END;
        (*ENDIF*)
    ...
    ELSE
        ...
        THEN
            IF  a_insert_select AND
                a12exist_type (acv, act_node, owner, func_name, proc_buf)
            THEN
                IF  a12method_exist (acv, proc_buf^.smethod.me_surrogate,
                    func_name, d_release, proc_buf)
                THEN
                    BEGIN
                    END;
                (*ENDIF*)
    ...
    THEN
        ...
        WITH a_mblock, mb_qual^ DO
            ...
            END;
        (*ENDWITH*)
        IF      ((param_cnt > 1) OR is_method_call)
        THEN
            BEGIN
            value_cnt   := 0;
            curr_n      := a_ap_tree^[act_node].n_lo_level;
            ...
            IF  colin.sci_len < 0
            THEN
                a12InitParamInfoRec(acv, proc_buf^.smethod.me_surrogate,
                      param_cnt, pEvalDataLength)
            ELSE
                pEvalDataLength := NIL;
            (*ENDIF*)
            IF  is_in_out > 0
            ...
            THEN
                ...
                WHILE (curr_n <> 0 ) AND
                    ...
                    IF  d_pseudo_ins_select AND (value_cnt = 2)
                    THEN
                        BEGIN
                        d_tabarr[1]   := d_tabarr[3];
                        d_acttabindex := 0;
                        a61_rel_old_table (acv, dmli, 1)
                        END;
                    (*ENDIF*)
            ...
            WITH a_mblock, mb_qual^ DO
                ...
                THEN
                    a07_b_put_error (acv,
                          e_too_many_mb_stackentries, -mb_st_max)
                ELSE
                    IF  a01aligned_cmd_len (mb_data_len) + sizeof (func_info)
                        > mb_data_size
                    THEN
                        a07_b_put_error (acv,
                              e_too_many_mb_data, -mb_data_size);
                ...
                THEN
                    ...
                    THEN
                        colin := param_info[colin.sci_len];
                    (*ENDIF*)
                    ...
                    WITH mb_st^ [mfirst_free] DO
                        ...
                        THEN
                            epos := mb_data_len + 1
                        ELSE
                            epos := a01aligned_cmd_len (mb_data_len) + 1;
                        (*ENDIF*)
                        curr_data_pos := epos;
                        elen_var      := sizeof (func_info);
                        ecol_tab[ 1 ] := chr(value_cnt);
                        ecol_tab[ 2 ] := chr(0)
                        END;
                    (*ENDWITH*)
                    ...
                    THEN
                        BEGIN
                        colin.sci_len := a12EvalDataLength (acv, pEvalDataLength);
                        IF  colin.sci_len  < 0
                        THEN
                            a07_b_put_error (acv, e_not_implemented, 1)
                        ELSE;
                            CASE colin.sci_typ OF
                                dnumber, dfixed, dfloat, dinteger, dsmallint :
                    ...
                    WITH mb_st^ [mfirst_free] DO
                        ...
                        etype       := st_dummy;
                        eop         := op_none;
                        epos        := colin.sci_com_type;
                        elen_var    := colin.sci_iolen;
                        ecol_tab[1] := chr(ord (colin.sci_typ));
                        ecol_tab[2] := chr(0)
                        END;
                    (*ENDWITH*)
                    mqual_cnt   := mqual_cnt + 1;
                    ...
                    WITH mb_data^ DO
                        BEGIN
                        proc_ptr                                := proc_buf;
                        func_info.dbf_acv_addr                  := @acv;
                        func_info.dbf_created                   := false;
                        func_info.dbf_dispid                    :=
                              proc_ptr^.smethod.me_dispid;
                        func_info.dbf_com_params.coclsid        :=
                              proc_ptr^.smethod.me_coclsid;
                        func_info.dbf_com_params.iid            :=
                              proc_ptr^.smethod.me_iid;
                        (*func_info.dbf_com_params.in_proc_server := true;      PTS 1112663 *)
                        (*func_info.dbf_com_params.debug_mode     := false; PTS 1112663 *)
                        func_info.dbf_com_params.session        :=
                              acv.a_transinf.tri_trans.trSessionId_gg00.ci4_gg00;
                        func_info.dbf_com_params.ikernel_sink   := @acv.a_kernel_sink;
                        (*func_info.dbf_com_params.coclassname  := NIL;CTS 1103603 FF 12-Aug-99*)
                        g10mv6 ('VAK641',   9,
                              sizeof (func_info), mb_data_size,
                              func_info, 1, mbp_buf, curr_data_pos,
                              sizeof (func_info),
                              a_return_segm^.sp1r_returncode);
                        mb_data_len := curr_data_pos - 1 +
                              sizeof (func_info)
                        END;
                    (*ENDWITH*)
                    END
...
THEN
    ...
    CASE scolinf.sci_typ OF
        ...
        OTHERWISE
            ...
            IF  dmli.d_datatype in [dcha, dche, dunicode]
            THEN
...
WITH acv.a_mblock, mb_qual^ DO
    IF  (first_free + 1 = acv.a_mblock.mb_qual^.mfirst_free  )
        AND
        ((proc_colin.sci_com_type = csp1_vt_lc_kb71_param_desc) OR
        ( dmli.d_datatype = dnumber))
    THEN
        mb_st^[first_free].ecol_pos := proc_colin.sci_com_type
    ELSE
        IF  (proc_colin.sci_typ <> dboolean) AND
            (proc_colin.sci_len > 0        )
        THEN
            IF  mfirst_free > mb_st_max
            THEN
                a07_b_put_error (acv,
            ...
            ELSE
                ...
                WITH mb_st^[mfirst_free] DO
                    BEGIN
                    etype := st_result;
                    IF  proc_buf^.smethod.me_type <> dbo_dbfunc
                    THEN
                        IF  is_in_out_param
                        THEN
                            eop := op_not_in
                    ...
                    epos        := proc_colin.sci_len;
                    elen_var    := proc_colin.sci_frac;
                    IF  proc_colin.sci_com_type > 0
                    THEN
                        ecol_pos := proc_colin.sci_com_type
                    ELSE
                        BEGIN
                        ecol_tab[1] :=
                              chr (ord (proc_colin.sci_typ));
...
(*
static char ident_mf[] = "@(#)vak641 SLOW I386 UNIX LINUX PTOC -REL30=1 -RELVER=R74 -DIAGNOSE=1 -BETA=1";
*)
