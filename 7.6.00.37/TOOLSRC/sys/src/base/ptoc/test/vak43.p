...
VAR
              ...
              a40sqlmode : ARRAY[tsp_sqlmode] OF tsp_c8;
              ...
              a01_i_public         : tsp_knl_identifier;
              ...
              g01serverdb_ident : tgg_serverdb_ident;
      ...
      FUNCTION
              a722test_col_qual (VAR acv : tak_all_command_glob;
      ...
      PROCEDURE
              a51build_userkey (VAR user_name : tsp_knl_identifier;
      ...
      PROCEDURE
        ...
        FUNCTION
              a40usertab_next (VAR acv : tak_all_command_glob;
                    VAR a41v      : tak40_show_glob;
                    use_tables    : boolean;
                    use_dbprocs   : boolean;
                    use_sequences : boolean;
                    VAR surrogate : tgg_surrogate;
                    VAR kind      : tgg_tablekind) : boolean;
        EXTERNAL ;
        ...
        PROCEDURE
              a40site (VAR acv : tak_all_command_glob;
                    VAR a41v             : tak40_show_glob;
                    VAR siteserverdbname : tsp_dbname;
                    VAR siteid           : tsp_nodeid);
        EXTERNAL ;
      ...
      FUNCTION
              a19IsDefaultRole (VAR acv : tak_all_command_glob;
                    VAR user_id : tgg_surrogate;
                    VAR role_id : tgg_surrogate) : boolean;
        EXTERNAL ;
      ...
      PROCEDURE
        ...
        PROCEDURE
              a06ignore_rsend_mess_buf (VAR acv : tak_all_command_glob;
        ...
        PROCEDURE
              a06set_mtree (VAR acv : tak_all_command_glob;
      ...
      PROCEDURE
              a01sets_identifier (VAR id : tsp_knl_identifier;
      ...
      PROCEDURE
        ...
        FUNCTION
              s20or4a(VAR str : tsp_buf; si : tsp_int4) : tsp_int4;
        EXTERNAL ;



        FUNCTION
              s20or4sw (VAR source : tsp_moveobj;
                    si             : tsp_int4;
                    sourceswap     : tsp_swap_kind;
        ...
        PROCEDURE
              s20sw_int4 (VAR val  : tsp_int4;
                    source_swap    : tsp_swap_kind;
                    destin_swap    : tsp_swap_kind);
        EXTERNAL ;



      PROCEDURE
              s02encrypt (VAR clearname : tsp_name;
                    VAR crypt : tsp_cryptpw);
        EXTERNAL ;



      PROCEDURE
              g02gettermsetdesc (VAR termset_name : tsp_knl_identifier;
      ...
      PROCEDURE
              g01datapart_init (VAR mblock : tgg_mess_block;
        ...
        PROCEDURE
              g01qual_init (VAR mblock : tgg_mess_block;
...
PROCEDURE
      a43execute (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43build_control_userrec (VAR acv : tak_all_command_glob;
            VAR a41v    : tak40_show_glob;
            VAR userrec : tak_userrecord);
        FORWARD;

PROCEDURE
      ak43connect_param  (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43all_roles  (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43one_db_role  (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob;
            role_buf : tak_sysbufferaddress;
            granteeId : tgg_surrogate);
        FORWARD;

PROCEDURE
      ak43roles  (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43session_roles  (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43one_role  (VAR acv : tak_all_command_glob;
            VAR a41v    : tak40_show_glob;
            VAR role_id : tgg_surrogate);
        FORWARD;

PROCEDURE
      ak43show_user  (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43all_user_show  (VAR acv : tak_all_command_glob;
            VAR a41v   : tak40_show_glob;
            user_check : t43_user_check);
        FORWARD;

PROCEDURE
      ak43one_user_show  (VAR acv : tak_all_command_glob;
            VAR a41v   : tak40_show_glob;
            user_check : t43_user_check);
        FORWARD;

PROCEDURE
      ak43connected_users (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43add_connected_users (VAR acv : tak_all_command_glob;
            VAR a41v    : tak40_show_glob;
            VAR tree    : tgg00_FileId;
            local_users : boolean);
        FORWARD;
...
FUNCTION
      ak43perm_count (VAR acv : tak_all_command_glob) : tsp_int4;
        FORWARD;

PROCEDURE
      ak43privileges (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43role_role_privileges (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43role_privileges (VAR acv : tak_all_command_glob;
            VAR a41v    : tak40_show_glob;
            VAR role_id : tgg_surrogate);
        FORWARD;

PROCEDURE
      ak43dependant_roles (VAR acv : tak_all_command_glob;
            VAR a41v   : tak40_show_glob;
            role_id    : tgg_surrogate);
        FORWARD;

PROCEDURE
      ak43put_owner_privileges (VAR acv : tak_all_command_glob;
            VAR a41v   : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43put_received_privileges (VAR acv : tak_all_command_glob;
            VAR a41v    : tak40_show_glob;
            is_role     : boolean;
            use_grantee : boolean;
            use_public  : boolean);
...
PROCEDURE
      ak43put_sequence_privileges (VAR acv : tak_all_command_glob;
            VAR a41v   : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43dbproc_privileges (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob);
        FORWARD;

PROCEDURE
      ak43dbproc_granted_privileges (VAR acv : tak_all_command_glob;
            VAR a41v : tak40_show_glob;
            VAR priv : tak_privilege;
...
PROCEDURE
      ak43granted_to (VAR acv : tak_all_command_glob;
            VAR a41v   : tak40_show_glob);
        FORWARD;
...
PROCEDURE
      a43get_granted_priv (VAR acv : tak_all_command_glob;
            ...
            VAR tablename : tsp_knl_identifier);
        FORWARD;

PROCEDURE
      ak43spriv_granted_to_show (VAR acv : tak_all_command_glob;
            VAR a41v        : tak40_show_glob;
            VAR owner       : tsp_knl_identifier;
            VAR tablename   : tsp_knl_identifier;
            object_kind     : integer;
            VAR priv        : tak_privilege;
            VAR granteeid   : tgg_surrogate;
            VAR grantorid   : tgg_surrogate;
            date            : tsp_int4;
            time            : tsp_int4);
        FORWARD;

PROCEDURE
      ak43put_one_priv (VAR priv : tak_privilege;
            VAR c40 : tsp_c40);
        FORWARD;

PROCEDURE
      ak43one_col_priv (VAR priv  : tak_privilege;
            VAR c40           : tsp_c40;
            colno             : integer;
...
FUNCTION
      ak43unique (VAR acv : tak_all_command_glob;
            is_synonym : boolean;
            VAR tabid  : tgg_surrogate;
            userid     : tgg_surrogate) : boolean;
        FORWARD;
...
WITH userrec DO
    BEGIN
    usurrogate   := cgg_zero_id;
    username     := a01controluser;
    urecordtyp   := [is_user_rec, is_group_rec];
    userkind     := ucontroluser;
    usersysdba   := false;
    uexclusive   := false;
    usergroup_id := cgg_zero_id;
    userowner_id := g01glob.sysuser_id;
    sysk           := a01defaultkey;
    sysk.sauthid   := userowner_id;
    sysk.sentrytyp := cak_euser;
    a10get_sysinfo (acv, sysk, d_fix, sysbuf, b_err);
    IF  b_err = e_ok
    THEN
        BEGIN
        ucreatedate   := sysbuf^.suser.ucreatedate;
        ucreatetime   := sysbuf^.suser.ucreatetime;
    ...
    (*ENDIF*)
    (* PTS 1107952 E.Z. *)
    FOR pi := up_unused1 TO cachelimit DO
        uparams[pi] := csp_maxint4;
    (*ENDFOR*)
    ucomment      := false;
    a41v.a4sysbuf := @userrec
    END;
(*ENDWITH*)
...
VAR
      ...
      termcharname : tsp_knl_identifier;
      format_buf   : tsp_c120;
...
WITH acv, a41v DO
    ...
    THEN
        ...
        termcharname := a01_il_b_identifier;
        g02gettermsetdesc (termcharname, a_mess_code, a_basic_code, ok);
        a40move (acv, a41v, @termcharname, sizeof (termcharname));
        (* PTS 1105303 E.Z. *)
        abs_session.c4 := acv.a_transinf.tri_trans.trSessionId_gg00.ci4_gg00;
        s20sw_int4 (abs_session.i4, sw_normal, g01code.kernel_swap);
        ...
        WITH a41v, a4p_arr.pinfop^.sresult DO
            a51get_date_format (acv, format_buf,
                  (bcolumn[a4index]^.cdatatyp = dunicode));
        (*ENDWITH*)
...
THEN
    ...
    sysk.sauthid[2] := chr(250);
    REPEAT
        a10next_sysinfo (acv, sysk, 2, d_fix,
              cak_euser, role_buf, b_err);
        IF  b_err = e_ok
        THEN
            BEGIN
            ak43one_db_role(acv, a41v, role_buf, role_buf^.suser.userowner_id);
            privkey.stableid  := role_buf^.syskey.sauthid;
            ...
            REPEAT
                ...
                IF  b_err = e_ok
                THEN
                    ak43one_db_role(acv, a41v, role_buf,
...
THEN
    ...
    REPEAT
        ...
        THEN
            ...
            a40move_const (acv, a41v,
                  @a40yes_no [cryptpw <> role_buf^.suser.userpassw],
                  sizeof (a40yes_no[true]));
            a40move_const (acv, a41v, @a40yes_no [
                  a19user_knows_role (acv, acv.a_curr_user_id,
                  role_buf^.syskey.sauthid)], sizeof (a40yes_no[true]));
            (* PTS 1104069 *)
            a40move_const (acv, a41v, @a40yes_no [
                  a19IsDefaultRole (acv, acv.a_curr_user_id,
                  role_buf^.syskey.sauthid)], sizeof (a40yes_no[true]));
            a40put_date_time (acv, a41v, role_buf^.suser.ucreatedate,
                  true, false);
            a40put_date_time (acv, a41v, role_buf^.suser.ucreatetime,
                  false, false)
            END;
        (*ENDIF*)
    UNTIL
...
WITH acv, a41v DO
    ...
    THEN
        ...
        THEN
            ak43all_user_show (acv, a41v, user_check)
        ELSE
            ak43one_user_show (acv, a41v, user_specified)
        (*ENDIF*)
        END;
    (*ENDIF*)
    END;
...
WITH acv, a41v   DO
    ...
    (*ENDWITH*)
    b_err := e_ok;
    WHILE (b_err = e_ok) AND (a_return_segm^.sp1r_returncode = 0) DO
        BEGIN
        a10next_sysinfo (acv, sysk, 2, d_release,
              cak_euser, a4sysbuf, b_err);
        IF  b_err = e_ok
        THEN
            BEGIN
            a4authname := a4sysbuf^.suser.username;
            ak43one_user_show (acv, a41v, user_check)
            END;
        (*ENDIF*)
        END;
    (*ENDWHILE*)
...
VAR
      full_info      : boolean;
      show_curr_user : boolean;
      user_param     : tak_userparams;
      b_err          : tgg_basis_error;
      ix             : integer;
      mult           : integer;
      int_value      : tsp_int4;
      owner_buf      : tak_sysbufferaddress;
      uv             : tsp_c8;
      group_name     : tsp_knl_identifier;
      owner_name     : tsp_knl_identifier;
      owner_key      : tgg_sysinfokey;
      control_userrec: tak_userrecord;
...
WITH acv, a41v   DO
    ...
    THEN
        ...
        ELSE
            ...
            IF  b_err = e_ok
            THEN
                a4sysk.sauthid := a4sysbuf^.suserref.ru_user_id;
            (*ENDIF*)
            IF  b_err = e_ok
            THEN
                BEGIN
                a4sysk.sentrytyp := cak_euser;
                a4sysk.skeylen   := mxak_standard_sysk;
                a10get_sysinfo (acv, a4sysk, d_fix, a4sysbuf, b_err);
                IF  b_err <> e_ok
                THEN
                    a07_b_put_error (acv, b_err, 1)
                (*ENDIF*)
        ...
        (*ENDIF*)
    (*ENDIF*)
    IF  (b_err = e_ok) AND (a_return_segm^.sp1r_returncode = 0)
    THEN
        BEGIN
        t01surrogate (ak_sem, 'user owner  ',
              a4sysbuf^.suser.userowner_id);
        t01surrogate (ak_sem, 'curr user   ',
              a_curr_user_id);
        t01surrogate (ak_sem, 'curr owner  ',
              a_acc_dba_id);
        (*== check if current user is allowed to see this user ==*)
        show_curr_user := a4sh_kind = sh_all_user;
        IF  NOT show_curr_user
        THEN
            IF  (a_current_user_kind = usysdba) OR
                (a_current_user_kind = udba)
            THEN
                show_curr_user :=
                      ((a4sysbuf^.suser.userkind     = usysdba)      OR
                      ( a4sysbuf^.suser.userkind     = udba)         OR
                      ( a4sysbuf^.suser.userowner_id = a_acc_dba_id) OR
                      ( a4sysbuf^.suser.userowner_id = a_curr_user_id))
                      OR
                      (user_check <> only_dbas)
            ELSE
                (* current user kind: RECOURCE or STANDARD    *)
                (* --> own DBA and own DBA-group without DBAs *)
                show_curr_user :=
                      (* own DBA *)
                      (a4sysbuf^.syskey.sauthid = a_acc_dba_id)
                      OR
                      (* own DBA-group, but no DBAs *)
                      ((a4sysbuf^.suser.userowner_id =  a_acc_dba_id) AND
                      ( a4sysbuf^.suser.userkind     <> usysdba)      AND
                      ( a4sysbuf^.suser.userkind     <> udba))
                      OR
                      (* user name is specified in command *)
                      (user_check = user_specified);
            (*ENDIF*)
        (*ENDIF*)
        IF  show_curr_user AND NOT (is_role_rec in a4sysbuf^.suser.urecordtyp)
        THEN
            BEGIN
            IF  (a4authname = a_acc_user) OR (a4sh_kind = sh_all_user)
            THEN
                full_info := true
            ELSE
                full_info := a21is_owner (acv, a4sysbuf^.suser);
            (*ENDIF*)
            WITH a4sysbuf^.suser DO
                BEGIN
                ;
                (*===== Username => Show-Record =====*)
                IF  NOT (is_user_rec in a4sysbuf^.suser.urecordtyp)
                THEN
                    a40move (acv, a41v, @a01_il_b_identifier,
                          sizeof (a01_il_b_identifier))
                ELSE
                    a40move (acv, a41v,
                          @a4authname, sizeof (a4authname));
                (*ENDIF*)
                ;
                (*=== Groupname => Show-Record =====*)
                IF  NOT (is_user_rec in a4sysbuf^.suser.urecordtyp)
                THEN (* user group *)
                    a40move (acv, a41v, @a4authname,
                          sizeof (a4authname))
                ELSE
                    BEGIN
                    ...
                    THEN (* group member *)
                        a06determine_username (acv,
                              usergroup_id, group_name)
                    ELSE
                        group_name := a01_il_b_identifier ;
                    (*ENDIF*)
                    a40move (acv, a41v, @group_name,
                          sizeof (group_name))
                    END;
                (*ENDIF*)
                ;
                (*==== Owner => Show-Record ========*)
                a06determine_username (acv,
                      userowner_id, owner_name);
                a40move (acv, a41v, @owner_name,
                      sizeof (owner_name));
                (* owner of owner ==>  show record *)
                IF  a4strategy.str_catalog.scat_col_needed[4]
                THEN
                    BEGIN
                    owner_key           := a01defaultkey;
                    owner_key.sauthid   := userowner_id;
                    owner_key.sentrytyp := cak_euser;
                    a10get_sysinfo (acv, owner_key,
                          d_release, owner_buf, b_err);
                    IF  b_err = e_ok
                    THEN
                        WITH owner_buf^.suser DO
                            a06determine_username (acv,
                                  userowner_id, owner_name)
                        (*ENDWITH*)
                    ELSE
                ...
                CASE userkind OF
                    ...
                    END;
                (*ENDCASE*)
                a40move_const (acv, a41v, @uv, sizeof (uv));
                ;
                (*==== exclusive => Show-Record =====*)
                IF  full_info
                THEN
                    BEGIN
                    IF  uexclusive
                ...
                (*ENDIF*)
                ;
                (*==== user_params => Show-Record ====*)
                (* PTS 1107952 E.Z. *)
                FOR user_param := up_unused1 TO costlimit DO
                    BEGIN
                    IF  user_param > up_unused2
                    THEN
                        a40move_i4 (acv, a41v, uparams[user_param],
                              NOT full_info OR
                              (uparams[user_param] = csp_maxint4),
                              0, NOT c_to_undef);
                    (*ENDIF*)
                    IF  a4sh_kind = sh_user_current
                    THEN
                        IF  user_param = up_unused1
                        THEN
                            a40move_i4 (acv, a41v,
                                  ak43perm_count (acv), NOT c_null,
                                  0, NOT c_to_undef)
                        ELSE
                            IF  user_param = up_unused2
                            THEN
                ...
                int_value := 0;
                mult      := 1;
                FOR ix := sizeof (usurrogate) DOWNTO
                      sizeof (usurrogate) - 4 + 1 DO
                    BEGIN
                    int_value := int_value +
                          ord (usurrogate[ix]) * mult;
                    mult      := mult * 256
                    END;
                (*ENDFOR*)
                a40move_i4 (acv, a41v, int_value,
                      NOT c_null, 0, NOT c_to_undef);
                a40put_date_time (acv, a41v, ucreatedate,
                      true, false);
                a40put_date_time (acv, a41v, ucreatetime,
                      false, false);
                a40put_date_time (acv, a41v, ualterdate, true,
                      false);
                a40put_date_time (acv, a41v, ualtertime, false,
                      false);
                a40put_date_time (acv, a41v, upwcreatedate, true,
                      (userkind = usysdba) OR NOT(full_info));
                a40put_date_time (acv, a41v, upwcreatetime, false,
                      (userkind = usysdba) OR NOT(full_info));
                a40site (acv, a41v, g01serverdb_ident.svServerdb_gg00,
                      g01serverdb_ident.svServernode_gg00);
                a40comment_descriptor (acv, a41v, ucomment,
                      usurrogate, 1, cm_user);
                a10_key_del (acv, a4sysk);
                END;
            (*ENDWITH*)
            END;
        (*ENDIF*)
        END; (* current user is allowed to see this user *)
    (*ENDIF*)
    END;
(*ENDWITH*)
...
WITH acv, a41v DO
    ...
    THEN
        ...
        ELSE
            BEGIN
            ak43add_connected_users (acv,
                  a41v, aux_file, c_local_users);
...
VAR
      ...
      pos          : integer;
      session      : tgg91_SessionNo;
      int_session  : tsp_int4;
      ak_cache     : tsp_int4;
      b_ptr        : tsp_moveobj_ptr;
    ...
    REPEAT
        ...
        THEN
            ...
            WHILE pos < set_result.bd_fill_len DO
                ...
                a40move_const (acv, a41v,
                      @b[pos+cgg_rec_key_offset+key_len.map_int+1 +
                      sizeof(tsp_knl_identifier) + 1],
                      mxsp_termid);
                int_session := abs (s20or4sw (b_ptr^,
...
THEN
    ...
    IF  b_err = e_ok
    THEN
        perm_count := s20or4a(mblock.mb_qual^.buf, mxsp_int4 + 1)
    ELSE
...
THEN
    WITH a41v DO
        ...
        use_grantee   := a722test_col_qual (acv,
              a41v, ln_grantee, ' ', @value, sizeof (value));
        use_grantor   := a722test_col_qual (acv,
              a41v, ln_grantor, ' ', @value, sizeof (value));
        value         := a01_i_public;
        use_public    := a722test_col_qual (acv,
              a41v, ln_grantee, ' ', @value, 12);
        ...
        THEN
            ...
            REPEAT
                ...
                THEN
                    ...
                    ELSE
                        BEGIN
                        is_private := a4private OR (a4next_owner = acv.a_curr_user_name);
                ...
                (*ENDIF*)
            UNTIL
                NOT ok OR (acv.a_return_segm^.sp1r_returncode <> 0);
            (*ENDREPEAT*)
            END;
        (*ENDIF*)
        IF  (acv.a_return_segm^.sp1r_returncode = 0) AND use_dbprocs
        THEN
            ak43dbproc_privileges (acv, a41v);
        (*ENDIF*)
        IF  (acv.a_return_segm^.sp1r_returncode = 0) AND use_roles
        THEN
...
VAR
      ...
      role_owner : tsp_knl_identifier;
      role       : tsp_knl_identifier;
      priv       : tak_privilege;
      rolekey    : tgg_sysinfokey;
      sysk       : tgg_sysinfokey;
...
THEN
    ...
    REPEAT
        ...
        THEN
            BEGIN
            ak43spriv_granted_to_show (acv, a41v, role_owner, role, cak_i_role,
...
WITH acv, a41v DO
    ...
    THEN
        ak43spriv_granted_to_show (acv, a41v, a_curr_user_name,
...
WITH acv, a41v DO
    ...
    REPEAT
        ...
        ELSE
            ...
            (*ENDIF*)
        (*ENDIF*)
        sysk.skeylen   := sysk.skeylen + mxgg_surrogate;
        REPEAT
            a10next_sysinfo (acv, sysk,
                  mxak_standard_sysk + mxgg_surrogate, d_release,
                  cak_eprivuser, priv_p, b_err);
            IF  b_err <> e_ok
            THEN
                BEGIN
            ...
            ELSE
                ...
                ak43spriv_granted_to_show (acv, a41v, a4next_owner,
...
VAR
      ...
      priv_p         : tak_sysbufferaddress;
      priv           : tak_privilege;
      grantee_id     : tgg_surrogate;
      seq_owner_name : tsp_knl_identifier;
      sysk           : tgg_sysinfokey;
...
WITH acv, a41v, a4p_arr.pbasep^.ssequence DO
    ...
    THEN
        ...
        REPEAT
            a10next_sysinfo (acv, sysk,
                  mxgg_surrogate, d_release, cak_esequencepriv, priv_p, b_err);
            IF  b_err = e_ok
            THEN
                BEGIN
                priv.priv_all_set := [r_sel];
                WITH priv_p^.sprocseqpriv DO
                    ak43spriv_granted_to_show (acv,
                          a41v, a_curr_user_name,
                          seq_name, cak_i_sequence, priv, sysk.suserid,
                          a_curr_user_id, psp_date, psp_time);
                (*ENDWITH*)
                END;
            (*ENDIF*)
        UNTIL
...
VAR
      ...
      priv_p      : tak_sysbufferaddress;
      grantee_id  : tgg_surrogate;
      proc_id     : tgg_surrogate;
      owner_name  : tsp_knl_identifier;
      priv        : tak_privilege;
      sysk        : tgg_sysinfokey;
      mei_sysk    : tgg_sysinfokey;
...
WITH acv, a41v DO
    ...
    THEN
        ...
        REPEAT
                ...
                THEN
                    WITH proc_p^.smethodinfo DO
                        ...
                        THEN
                            ...
                            sysk.suserid   := grantee_id;
                            sysk.skeylen   :=
                                  sysk.skeylen + mxgg_surrogate;
                            a10get_sysinfo (acv, sysk,
                                  d_release, priv_p, b_err);
                            IF  b_err = e_ok
                            THEN
                                ak43spriv_granted_to_show (acv, a41v,
                                      owner_name, mei_name, cak_i_dbproc,
            ...
            (*ENDWHILE*)
        UNTIL
            (repeat_cnt >= 2) OR (a_return_segm^.sp1r_returncode <> 0);
        (*ENDREPEAT*)
...
WHILE (next) AND (acv.a_return_segm^.sp1r_returncode = 0) DO
    BEGIN
    (* get next privrecord *)
        ...
        ELSE
            ...
            THEN (* not (wrong grantor) *)
                ...
                THEN (* grantee is not the grantor *)
                    ...
                    ak43spriv_granted_to_show (acv, a41v, owner,
...
VAR
      ...
      c8            : tsp_c8;
      grantee_name  : tsp_knl_identifier;
      grantee_owner : tsp_knl_identifier;
      grantor_name  : tsp_knl_identifier;
      column        : tsp_knl_identifier;
...
THEN
    WITH acv DO
        BEGIN
        ak43unique        := false;
        buf.keylen        := 2 * mxgg_surrogate;
        buf.len           := 2 * mxgg_surrogate + cgg_rec_key_offset;
...
(*
static char ident_mf[] = "@(#)vak43 SLOW I386 UNIX LINUX PTOC -REL30=1 -RELVER=R74 -DIAGNOSE=1 -BETA=1";
*)
