...
class ReportGenerator:
    ...
    def generate (self, session):
        for parameter in self.getParameters ():
            self.overviewReport (session, parameter)
            self.makeReport (session, 'imf', parameter)
            self.sutReport (session, parameter)
    ...
    def overviewReport (self, session, stream, parameter, configIDs):
        title = self.getTitle ()
    ...
    def makeReport (self, session, stream, parameter, configIDs):
        target = 'imf'
    ...
    def sutReport (self, session, stream, parameter, configIDs):
