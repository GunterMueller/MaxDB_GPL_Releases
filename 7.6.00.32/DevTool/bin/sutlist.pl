...
__END__
 ...
 ruft sutsingle mit einer Liste von Testströmen aus einer Datei auf.
...
Option:
     ...
     -l <filename>      ::= Liste der zu testenden Testströme

     in der Liste können Testfiles mit '#' am Zeilenanfang auskommentiert
     werden
