#ifndef JOIN_LEGACYACCESSOPERATOR_HPP
#define JOIN_LEGACYACCESSOPERATOR_HPP
/*!
 * @file
...
class Join_LegacyAccessOperator : public Join_AccessOperator
{
public:
    ...
    //! destructor
    virtual ~Join_LegacyAccessOperator();
    //@}
    ...
    { return Join_AccessOperator::GetNullRecord( recptr ); }
    //@}
protected:
...
private:
    ...
    virtual SAPDB_Int4 rec_offset() const { return m_RecOffset; }
    
    tgg00_BasisError legacy_access();
    
    // member variables
    tgg00_FileId  m_ResultFile;
    tgg00_FilePos m_TreePos;
    tgg00_BdSetResultRecord m_SelectDesc;
    SAPDB_Int4 m_RecOffset;
