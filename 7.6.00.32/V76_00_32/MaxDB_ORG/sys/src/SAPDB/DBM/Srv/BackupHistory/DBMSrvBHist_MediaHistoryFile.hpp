/*! 
  \file    DBMSrvBHist_MediaHistoryFile.hpp
  \author  TiloH
...
class DBMSrvBHist_MediaHistoryFile: public DBMSrvBHist_File
{
  public:
    DBMSrvBHist_MediaHistoryFile();
    ~DBMSrvBHist_MediaHistoryFile();

    
    Tools_List<DBMSrvBHist_Part *> & getMediaList();

  private:
    tcn00_Error useReadLine(DBMSrv_Reply & Reply);

    Tools_List<DBMSrvBHist_Part *> mediaList;
};
