/*!
  \file    DBMSrvCmdScd_SchedulerStop.hpp
  \author  MarcW
...
#if !defined(DBMSrvCmdScd_SchedulerStop_hpp)
#define DBMSrvCmdScd_SchedulerStop_hpp


/*! 
    @brief Class for handling the DBMServer command scheduler_stop
*/
class DBMSrvCmdScd_SchedulerStop: public DBMSrvCmdScd_SchedulerCommand {
public:
    /*! @brief constructor */
    DBMSrvCmdScd_SchedulerStop();
...
#endif //DBMSrvCmdScd_SchedulerStop_hpp
