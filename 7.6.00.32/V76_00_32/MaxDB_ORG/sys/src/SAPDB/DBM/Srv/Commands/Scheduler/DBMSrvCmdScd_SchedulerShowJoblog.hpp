/*!
  \file    DBMSrvCmdScd_SchedulerShowJoblog.hpp
  \author  MarcW
...
#if !defined(DBMSrvCmdScd_SchedulerShowJoblog_hpp)
#define DBMSrvCmdScd_SchedulerShowJoblog_hpp
...
*/
class DBMSrvCmdScd_SchedulerShowJoblog: public DBMSrv_Command {
public:
    /*! @brief constructor */
    DBMSrvCmdScd_SchedulerShowJoblog();
...
#endif //DBMSrvCmdScd_SchedulerShowJoblog_hpp
