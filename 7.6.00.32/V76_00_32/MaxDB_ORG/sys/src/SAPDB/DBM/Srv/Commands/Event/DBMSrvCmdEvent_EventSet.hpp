/*!
  \file    DBMSrvCmdEvent_EventSet.hpp
  \author  MarcW
...
#if !defined(DBMSrvCmdEvent_EventSet_hpp)
#define DBMSrvCmdEvent_EventSet_hpp

#include "DBM/Srv/Commands/DBMSrvCmd_EventAdministrationCommand.hpp"

/*! 
    @brief Class for handling the DBMServer command event_set
*/
class DBMSrvCmdEvent_EventSet: public DBMSrvCmd_EventAdministrationCommand {
public:
    /*! @brief constructor */
    DBMSrvCmdEvent_EventSet();
...
#endif //DBMSrvCmdEvent_EventSet_hpp
