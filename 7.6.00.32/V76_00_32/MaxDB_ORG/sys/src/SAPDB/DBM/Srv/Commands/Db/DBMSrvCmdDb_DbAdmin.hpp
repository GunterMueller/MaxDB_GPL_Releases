...
#if !defined(DBMSrvCmdDb_DbAdmin_hpp)
#define DBMSrvCmdDb_DbAdmin_hpp
...
*/
class DBMSrvCmdDb_DbAdmin: public DBMSrv_Command {
public:
    /*! @brief constructor , obsolete flag for derived old commands */
    DBMSrvCmdDb_DbAdmin( bool obsolete = false );

    virtual ~DBMSrvCmdDb_DbAdmin() {}
    ...
    */
    ...
    static const char * getCommandName() {return "db_admin";}
