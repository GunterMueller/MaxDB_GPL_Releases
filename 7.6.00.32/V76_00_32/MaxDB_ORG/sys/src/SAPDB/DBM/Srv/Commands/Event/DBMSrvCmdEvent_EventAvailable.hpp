...
#if !defined(DBMSrvCmdEvent_EventAvailable_hpp)
#define DBMSrvCmdEvent_EventAvailable_hpp


/*! 
    @brief Class for handling the DBMServer command event_available
*/
class DBMSrvCmdEvent_EventAvailable: public DBMSrv_Command {
public:
    /*! @brief constructor */
    DBMSrvCmdEvent_EventAvailable();
...
#endif //DBMSrvCmdEvent_EventAvailable_hpp
