/*!
  \file    DBMSrvCmdMedium_MediumPut.hpp
  \author  TiloH
...
class DBMSrvCmdMedium_MediumPut : public DBMSrv_Command
{
  public:
    DBMSrvCmdMedium_MediumPut();
    ...
    static const char * const m_LongHelp; //!< pointer to long help string, used in vcn10.cpp
};
