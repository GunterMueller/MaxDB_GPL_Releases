/*******************************************************************************
  module:       DBMP2F_ReactionDelay.hpp
  ------------------------------------------------------------------------------
  responsible:  TiloH
...
#if !defined(_DBMP2F_ReactionDelay_hpp)
#define _DBMP2F_ReactionDelay_hpp
...
// -----------------------------------------------------------------------------
// class DBMP2F_ReactionDelay
// -----------------------------------------------------------------------------

class DBMP2F_ReactionDelay: public DBMP2F_Reaction
{
  public:
    DBMP2F_ReactionDelay(int TheDelayTime);
