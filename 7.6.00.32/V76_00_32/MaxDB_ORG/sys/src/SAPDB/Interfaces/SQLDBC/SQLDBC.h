...
&if $RELVER = R75 
 * @note This feature is available since version 7.5.0.24 of SQLDBC
&else
...
&if $RELVER = R75 
 * @note This feature is only available since version 7.6 of SQLDBC
&else
 ...
 */
#define SQLDBC_CHeaderVersion "SQLDBC_C.H  <MAJOR_VERSION>.<MINOR_VERSION>.<CORRECTION_LEVEL>    BUILD <BUILD_NUMBER_EX_STRING>"
&else
/**
 * @brief The version string for the SQLDBC.H file.
 */
static const char* SQLDBCHeaderVersion = "SQLDBC.H  <MAJOR_VERSION>.<MINOR_VERSION>.<CORRECTION_LEVEL>    BUILD <BUILD_NUMBER_EX_STRING>";
&endif
/*
...
&else
  ...
  /**
   * @internal
   * Constructor that uses a special allocator. Only used internally
   * to MaxDB.
   * @param allocator.
   */
