/*!
  @file           IFRConversion_DateUCS2Converter.h.h
  @author         D039759
  @ingroup        IFR_DataConv
  @brief          Conversion from/to DATE
  @see
...
\endif
*/
#ifndef IFRCONVERSION_DATEUCS2CONVERTER_H
#define IFRCONVERSION_DATEUCS2CONVERTER_H

#include "Interfaces/Runtime/Conversion/IFRConversion_UCS2CharDataConverter.h"

/**
 * @ingroup IFR_DataConv
 * Converter for date values. This converter converts DATE values (consisting
 * of year, month and day) into and from various types.
 */
class IFRConversion_DateUCS2Converter
...
public:
     ...
     */
    IFRConversion_DateUCS2Converter(IFR_ShortInfo& shortinfo,
                                    SAPDBMem_IRawAllocator& allocator,
                                    IFR_Connection& connection);


    virtual ~IFRConversion_DateUCS2Converter();
    ...
    IFR_Retcode 
    appendBinaryOutput(IFRPacket_DataPart&   datapart,
                       char                 *data,
                       IFR_Length            datalength,
                       IFR_Length*           lengthindicator,
                       IFR_ConnectionItem   &clink,
...
#endif //IFRCONVERSION_DATECONVERTER_H
