/*!
  @file           SysView_Sessions.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the SESSIONS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_SESSIONS_HPP
#define SYSVIEW_SESSIONS_HPP
...
class SysView_ResultCollector; //!< forward declaration;

/*!
   @class    SysView_Sessions
   @brief    This class is used to handle the system table named
             'SESSIONS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_Sessions : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_Sessions(SQLMan_Context &context,
    ...
    /*@}*/
    /*-----------------------------------------------------------------------*/
    friend class SysView_ResultCollector;
};



#endif  /* SYSVIEW_SESSIONS_HPP */
