/*!
  @file           SysView_HotStandbyGroup.hpp
  @author         JoergM
  @ingroup        SystemViews
  @brief   This contains a class object representing the HOTSTANDBYGROUP view.
  @see            
*/
/*
...
#ifndef SYSVIEW_HOTSTANDBYGROUP_HPP
#define SYSVIEW_HOTSTANDBYGROUP_HPP
...
/*!
   @class    SysView_HotStandbyGroup
   @brief    This class is used to handle the system table named
             'HOTSTANDBYGROUP'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_HotStandbyGroup : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_HotStandbyGroup(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_HOTSTANDBYGROUP_HPP */
