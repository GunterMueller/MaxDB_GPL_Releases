/*!
  @file     SysView_CommandCacheStatisticsReset.hpp
  @author   DirkT
  @ingroup  SystemViews
...
#ifndef SYSVIEW_COMMANDCACHESTATISTICSRESET_HPP
#define SYSVIEW_COMMANDCACHESTATISTICSRESET_HPP
...
/*!
   @class    SysView_CommandCacheStatisticsReset
   @brief    This class is used to handle the system table named
             'COMMANDCACHESTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_CommandCacheStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_CommandCacheStatisticsReset(SQLMan_Context    &context,
...
#endif  /* SYSVIEW_COMMANDCACHESTATISTICS_HPP */
