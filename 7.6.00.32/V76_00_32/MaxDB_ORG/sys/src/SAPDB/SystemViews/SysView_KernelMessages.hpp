/*!
  @file           SysView_KernelMessages.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the KERNELMESSAGES view.
  @see            
*/
/*
...
#ifndef SYSVIEW_KERNELMESSAGES_HPP
#define SYSVIEW_KERNELMESSAGES_HPP
...
/*!
   @class    SysView_KernelMessages
   @brief    This class is used to handle the system table named
             'KERNELMESSAGES'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_KernelMessages : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_KernelMessages(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_KERNELMESSAGES_HPP */
