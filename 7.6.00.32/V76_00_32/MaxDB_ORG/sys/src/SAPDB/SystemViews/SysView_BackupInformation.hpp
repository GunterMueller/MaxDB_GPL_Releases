/*!
  @file           SysView_BackupInformation.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the BACKUPINFORMATION view.
  @see            
*/
/*
...
#ifndef SYSVIEW_BACKUPINFORMATION_HPP
#define SYSVIEW_BACKUPINFORMATION_HPP
...
/*!
   @class    SysView_BackupInformation
   @brief    This class is used to handle the system table named
             'BACKUPINFORMATION'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_BackupInformation : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_BackupInformation(SQLMan_Context	&context,
...
#endif  /* SYSVIEW_BACKUPINFORMATION_HPP */
