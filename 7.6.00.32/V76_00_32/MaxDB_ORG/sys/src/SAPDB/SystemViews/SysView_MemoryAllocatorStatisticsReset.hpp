/*!
  @file           SysView_MemoryAllocatorStatisticsReset.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the MEMORYALLOCATORSTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_MEMORYALLOCATORSTATISTICSRESET_HPP
#define SYSVIEW_MEMORYALLOCATORSTATISTICSRESET_HPP
...
/*!
   @class    SysView_MemoryAllocatorStatisticsReset
   @brief    This class is used to handle the system table named
             'MEMORYALLOCATORSTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_MemoryAllocatorStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_MemoryAllocatorStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_MEMORYALLOCATORSTATISTICSRESET_HPP */
