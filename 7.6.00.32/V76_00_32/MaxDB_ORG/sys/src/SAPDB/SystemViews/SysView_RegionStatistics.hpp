/*!
  @file           SysView_RegionStatistics.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the REGIONSTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_REGIONSTATISTICS_HPP
#define SYSVIEW_REGIONSTATISTICS_HPP
...
/*!
   @class    SysView_RegionStatistics
   @brief    This class is used to handle the system table named
             'REGIONSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_RegionStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_RegionStatistics(SQLMan_Context &context,
...
private:
    ...
    friend class SysView_RegionStatisticsReset;
    /*-----------------------------------------------------------------------*/
    /*@}*/
    /*-----------------------------------------------------------------------*/
};
...
#endif  /* SYSVIEW_REGIONSTATISTICS_HPP */
