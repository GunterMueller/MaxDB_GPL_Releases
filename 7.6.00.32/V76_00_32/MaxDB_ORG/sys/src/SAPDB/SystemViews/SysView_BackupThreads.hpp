/*!
  @file           SysView_BackupThreads.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the BACKUPTHREADS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_BACKUPTHREADS_HPP
#define SYSVIEW_BACKUPTHREADS_HPP
...
/*!
   @class    SysView_BackupThreads
   @brief    This class is used to handle the system table named
             'BACKUPTHREADS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_BackupThreads : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_BackupThreads(SQLMan_Context    &context,
...
#endif  /* SYSVIEW_BACKUPTHREADS_HPP */
