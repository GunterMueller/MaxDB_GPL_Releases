/*!
  @file           SysView_ActiveConfiguration.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the ACTIVECONFIGURATION view.
  @see            
*/
/*
...
#ifndef SYSVIEW_ACTIVECONFIGURATION_HPP
#define SYSVIEW_ACTIVECONFIGURATION_HPP
...
/*!
   @class    SysView_ActiveConfiguration
   @brief    This class is used to handle the system table named
             'ACTIVECONFIGURATION'. It mainly provides the Create() and 
             Execute() functions for this table.

 */


class SysView_ActiveConfiguration : public SysView_SysViewBase
{
...
public:
   ...
   /*@{*/
    ...
    /*!
       ...
       @return  none
     */
    SysView_ActiveConfiguration(SQLMan_Context	&context,
...
#endif  /* SYSVIEW_ACTIVECONFIGURATION_HPP */
