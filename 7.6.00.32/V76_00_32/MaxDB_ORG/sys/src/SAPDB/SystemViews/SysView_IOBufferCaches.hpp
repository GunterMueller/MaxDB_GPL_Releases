/*!
  @file           SysView_IOBufferCaches.hpp
  @author         Henrik
  @ingroup        SystemViews
  @brief   This contains a class object representing the IOBUFFERCACHES view.
  @see            
*/
/*
...
#ifndef SYSVIEW_IOBUFFERCACHES_HPP
#define SYSVIEW_IOBUFFERCACHES_HPP
...
/*!
   @class    SysView_IOBufferCaches
   @brief    This class is used to handle the system table named
             'IOBUFFERCACHES'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_IOBufferCaches : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_IOBufferCaches(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_IOBUFFERCACHES_HPP */
