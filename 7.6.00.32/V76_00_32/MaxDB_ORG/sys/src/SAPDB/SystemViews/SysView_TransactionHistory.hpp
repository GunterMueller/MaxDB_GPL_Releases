/*!
  @file           SysView_TransactionHistory.hpp
  @author         FerdiF
  @ingroup        SystemViews
  @brief          This contains a class object representing the TRANSACTIONSHISTORY view.
  @see            
*/
/*
...
#ifndef SysView_TransactionHistory_HPP
#define SysView_TransactionHistory_HPP
...
/*!
   @class    SysView_TransactionHistory
   @brief    This class is used to handle the system table named
             'TRANSACTIONHISTORY'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_TransactionHistory : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_TransactionHistory(SQLMan_Context  &context,
...
#endif  /* SysView_TransactionHistory_HPP */
