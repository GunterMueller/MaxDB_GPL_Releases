/*!
  @file           SysView_RegionInformation.hpp
  @author         ElkeZ
  @ingroup   SystemViews
  @brief   This contains a class object representing the REGIONINFORMATION view.
  @see            
*/
/*
...
#ifndef SYSVIEW_REGIONINFORMATION_HPP
#define SYSVIEW_REGIONINFORMATION_HPP
...
/*!
   @class    SysView_RegionInformation
   @brief    This class is used to handle the system table named
             'REGIONINFORMATION'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_RegionInformation : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_RegionInformation(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_REGIONINFORMATION_HPP */
