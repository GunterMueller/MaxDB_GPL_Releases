/*!
  @file           SysView_Schemas.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the SCHEMAS view.
  @see            
*/
/* 
...
#ifndef SYSVIEW_SCHEMAS_HPP
#define SYSVIEW_SCHEMAS_HPP
...
/*!
   @class    SysView_Schemas
   @brief    This class is used to handle the system table named
             'SCHEMAS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_Schemas : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_Schemas(SQLMan_Context  &context,
