/*!
  @file           SysView_SpinLockStatisticsReset.hpp
  @author         ElkeZ
  @ingroup   SystemViews
  @brief   This contains a class object representing the SPINLOCKSTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_SPINLOCKSTATISTICSRESET_HPP
#define SYSVIEW_SPINLOCKSTATISTICSRESET_HPP
...
/*!
   @class    SysView_SpinLockStatisticsReset
   @brief    This class is used to handle the system table named
             'SPINLOCKSTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_SpinLockStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_SpinLockStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_SPINLOCKSTATISTICSRESET_HPP */
