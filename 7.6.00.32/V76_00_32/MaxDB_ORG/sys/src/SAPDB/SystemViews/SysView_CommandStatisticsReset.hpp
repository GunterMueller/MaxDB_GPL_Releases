/*!
  @file     SysView_CommandStatisticsReset.hpp
  @author   DirkT
  @ingroup  SystemViews
...
#ifndef SYSVIEW_COMMANDSTATISTICSRESET_HPP
#define SYSVIEW_COMMANDSTATISTICSRESET_HPP
...
/*!
   @class    SysView_CommandStatisticsReset
   @brief    This class is used to handle the system table named
             'COMMANDSTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_CommandStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_CommandStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_COMMANDSTATISTICS_HPP */
