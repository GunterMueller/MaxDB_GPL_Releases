/*!
  @file           SysView_ReaderWriterLockStatistics.hpp
  @author         Robin
  @ingroup        SystemViews
...
#ifndef SYSVIEW_READERWRITERLOCKSTATISTICS_HPP
#define SYSVIEW_READERWRITERLOCKSTATISTICS_HPP
...
/*!
   @class    SysView_ReaderWriterLockStatistics
   @brief    This class is used to handle the system table named
             'READERWRITERLOCKSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_ReaderWriterLockStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_ReaderWriterLockStatistics(SQLMan_Context  &context,
...
private:
    ...
    friend class SysView_ReaderWriterLockStatisticsReset;
    /*-----------------------------------------------------------------------*/
    /*@}*/
    /*-----------------------------------------------------------------------*/
};
...
#endif  /* SYSVIEW_READERWRITERLOCKSTATISTICS_HPP */
