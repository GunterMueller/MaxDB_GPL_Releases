/*!
  @file           SysView_ReaderWriterLockWaitingTasks.hpp
  @author         Robin
  @ingroup        SystemViews
  @brief   This contains a class object representing the ReaderWriterLockWaitingTasks view.
  @see            
*/
/*
...
#ifndef SYSVIEW_READERWRITERLOCKWAITINGTASKS_HPP
#define SYSVIEW_READERWRITERLOCKWAITINGTASKS_HPP
...
/*!
   @class    SysView_ReaderWriterLockWaitingTasks
   @brief    This class is used to handle the system table named
             'READERWRITERLOCKWAITINGTASKS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_ReaderWriterLockWaitingTasks : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_ReaderWriterLockWaitingTasks(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_READERWRITERLOCKWAITINGTASKS_HPP */
