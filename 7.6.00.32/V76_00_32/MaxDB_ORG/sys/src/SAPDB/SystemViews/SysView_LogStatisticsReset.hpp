/*!
  @file           SysView_LogStatisticsReset.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the LOGSTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_LOGSTATISTICSRESET_HPP
#define SYSVIEW_LOGSTATISTICSRESET_HPP
...
/*!
   @class    SysView_LogStatisticsReset
   @brief    This class is used to handle the system table named
             'LOGSTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_LogStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_LogStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_LOGSTATISTICSRESET_HPP */
