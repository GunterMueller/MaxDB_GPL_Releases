/*!
  @file           SysView_Servertasks.hpp
  @author         UweH
  @ingroup        SystemViews
  @brief   This contains a class object representing the SERVERTASKS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_SERVERTASKS_HPP
#define SYSVIEW_SERVERTASKS_HPP
...
class SysView_Servertasks : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_Servertasks(SQLMan_Context	&context,
