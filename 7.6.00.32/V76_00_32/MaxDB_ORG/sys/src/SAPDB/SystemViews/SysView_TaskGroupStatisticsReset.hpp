/*!
  @file           SysView_TaskGroupStatisticsReset.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the TASKGROUPSTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_TASKGROUPSTATISTICSRESET_HPP
#define SYSVIEW_TASKGROUPSTATISTICSRESET_HPP
...
/*!
   @class    SysView_TaskGroupStatisticsReset
   @brief    This class is used to handle the system table named
             'TASKGROUPSTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_TaskGroupStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_TaskGroupStatisticsReset(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_TASKGROUPSTATISTICSRESET_HPP */
