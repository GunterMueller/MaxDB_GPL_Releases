/*!
  @file           SysView_OMSVersions.hpp
  @author         ElkeZ
  @ingroup   SystemViews
  @brief   This contains a class object representing the OMSVERSIONS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_OMSVERSIONS_HPP
#define SYSVIEW_OMSVERSIONS_HPP
...
/*!
   @class    SysView_OMSVersions
   @brief    This class is used to handle the system table named
             'OMSVERSIONS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_OMSVersions : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_OMSVersions(SQLMan_Context  &context,
