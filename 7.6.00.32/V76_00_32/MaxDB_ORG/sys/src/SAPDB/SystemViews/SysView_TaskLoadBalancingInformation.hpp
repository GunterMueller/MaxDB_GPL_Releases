/*!========================================================================
  ...
  @file         SysView_TaskLoadBalancingInformation.hpp
  @ingroup      
  @author       RaymondR

  @brief        This header module defines the "TaskLoadBalancingInformation" view class.


  @since        2004-06-01  17:27
  @sa           
...
#ifndef SYSVIEW_TASKLOADBALANCINGINFORMATION_HPP
#define SYSVIEW_TASKLOADBALANCINGINFORMATION_HPP
...
/*!
   @class    SysView_TaskLoadBalancingInformation
   @brief    This class is used to handle the system table named
             'TASKLOADBALANCING'. It mainly provides the Create() and
             Execute() functions for this table.
 */


class SysView_TaskLoadBalancingInformation : public SysView_SysViewBase
{
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_TaskLoadBalancingInformation( SQLMan_Context  &context,
...
#endif  /* SYSVIEW_TASKLOADBALANCINGINFORMATION_HPP */
