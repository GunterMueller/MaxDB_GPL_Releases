/*!
  @file           SysView_RegionStatisticsReset.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the REGIONSTATISTICSRESET view.
  @see            
*/
/*
...
#ifndef SYSVIEW_REGIONSTATISTICSRESET_HPP
#define SYSVIEW_REGIONSTATISTICSRESET_HPP
...
/*!
   @class    SysView_RegionStatisticsReset
   @brief    This class is used to handle the system table named
             'REGIONSTATISTICSRESET'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_RegionStatisticsReset : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_RegionStatisticsReset(SQLMan_Context    &context,
...
#endif  /* SYSVIEW_REGIONSTATISTICSRESET_HPP */
