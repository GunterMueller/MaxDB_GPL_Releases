/*!
  @file           SysView_HistoryCleanupStatistics.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the HISTORYCLEANUPSTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_HISTORYCLEANUPSTATISTICS_HPP
#define SYSVIEW_HISTORYCLEANUPSTATISTICS_HPP
...
/*!
   @class    SysView_HistoryCleanupStatistics
   @brief    This class is used to handle the system table named
             'HISTORYCLEANUPSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.

 */


class SysView_HistoryCleanupStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_HistoryCleanupStatistics(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_HISTORYCLEANUPSTATISTICS_HPP */
