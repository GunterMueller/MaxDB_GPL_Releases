/*!
  @file           SysView_LogInformation.hpp
  @author         ElkeZ
  @ingroup   SystemViews
  @brief   This contains a class object representing the LOGINFORMATION view.
  @see            
*/
/*
...
#ifndef SYSVIEW_LOGINFORMATION_HPP
#define SYSVIEW_LOGINFORMATION_HPP
...
/*!
   @class    SysView_LogInformation
   @brief    This class is used to handle the system table named
             'LOGINFORMATION'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_LogInformation : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_LogInformation(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_LOGINFORMATION_HPP */
