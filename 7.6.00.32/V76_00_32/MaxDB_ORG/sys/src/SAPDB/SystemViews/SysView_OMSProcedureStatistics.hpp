/*!
  @file           SysView_OMSProcedureStatistics.hpp
  @author         ElkeZ
  @ingroup   SystemViews
  @brief   This contains a class object representing the OMSPROCEDURESTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_OMSPROCEDURESTATISTICS_HPP
#define SYSVIEW_OMSPROCEDURESTATISTICS_HPP
...
/*!
   @class    SysView_OMSProcedureStatistics
   @brief    This class is used to handle the system table named
             'OMSPROCEDURESTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_OMSProcedureStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_OMSProcedureStatistics(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_OMSPROCEDURESTATISTICS_HPP */
