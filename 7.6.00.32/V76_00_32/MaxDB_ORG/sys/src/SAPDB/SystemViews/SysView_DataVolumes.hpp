...
#ifndef SYSVIEW_DATAVOLUMES_HPP
#define SYSVIEW_DATAVOLUMES_HPP
...
/*!
   @class    SysView_DataVolumes
   @brief    This class is used to handle the system table named
             'DATAVOLUMES'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_DataVolumes : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_DataVolumes(SQLMan_Context   &context,
