/*!
  @file           SysView_Miscellaneous.hpp
  @author         ElkeZ
  @ingroup        SystemViews
  @brief   This contains a class object representing the MISCELLANEOUS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_MISCELLANEOUS_HPP
#define SYSVIEW_MISCELLANEOUS_HPP
...
/*!
   @class    SysView_Miscellaneous
   @brief    This class is used to handle the system table named
             'MISCELLANEOUS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_Miscellaneous : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_Miscellaneous(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_MISCELLANEOUS_HPP */
