/*!
  @file     SysView_UnloadedStatements.hpp
  @author   DirkT
  @ingroup  SystemViews
...
#ifndef SysView_UnloadedStatements_HPP
#define SysView_UnloadedStatements_HPP
...
/*!
   @class    SysView_UnloadedStatements
   @brief    This class is used to handle the system table named
             'COMMANDSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_UnloadedStatements : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_UnloadedStatements(SQLMan_Context &context,
...
#endif  /* SysView_UnloadedStatements_HPP */
