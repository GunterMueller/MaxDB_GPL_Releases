/*!
  @file           SysView_SpinLockPoolStatistics.hpp
  @author         Robin
  @ingroup        SystemViews
  @brief   This contains a class object representing the SPINLOCKSTATISTICS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_SPINLOCKPOOLSTATISTICS_HPP
#define SYSVIEW_SPINLOCKPOOLSTATISTICS_HPP
...
/*!
   @class    SysView_SpinLockPoolStatistics
   @brief    This class is used to handle the system table named
             'SPINLOCKPOOLSTATISTICS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_SpinLockPoolStatistics : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_SpinLockPoolStatistics(SQLMan_Context  &context,
...
private:
    /*!
       @brief   the timestamp of the last reset call - 0 if reset has never been called
     */
    static SAPDB_UInt8 m_lastResetTimestamp;
    friend class SysView_SpinLockPoolStatisticsReset;
...
#endif  /* SYSVIEW_SPINLOCKPOOLSTATISTICS_HPP */
