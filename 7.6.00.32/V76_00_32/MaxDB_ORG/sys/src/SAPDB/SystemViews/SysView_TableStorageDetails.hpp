/*!
  @file           SysView_TableStorageDetails.hpp
  @author         ElkeZ
  @ingroup   SystemViews
  @brief   This contains a class object representing the TABLESTORAGEDETAILS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_TABLESTORAGEDETAILS_HPP
#define SYSVIEW_TABLESTORAGEDETAILS_HPP
...
class Catalog_TableDescriptor; //!< forward

/*!
   @class    SysView_TableStorageDetails
   @brief    This class is used to handle the system table named
             'TABLESTORAGEDETAILS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_TableStorageDetails : public SysView_SysViewBase
{
...
public:
     ...
     */
    SysView_TableStorageDetails(SQLMan_Context  &context,
...
private :
    void AddTableStatistics (Catalog_TableDescriptor& Table); //!< inserts statistics of one table
...
#endif  /* SYSVIEW_TABLESTORAGEDETAILS_HPP */
