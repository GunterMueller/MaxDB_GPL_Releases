/*!
  @file           SysView_Transactions.hpp
  @author         ElkeZ
  @ingroup   SystemViews
  @brief   This contains a class object representing the TRANSACTIONS view.
  @see            
*/
/*
...
#ifndef SYSVIEW_TRANSACTIONS_HPP
#define SYSVIEW_TRANSACTIONS_HPP
...
/*!
   @class    SysView_Transactions
   @brief    This class is used to handle the system table named
             'TRANSACTIONS'. It mainly provides the Create() and 
             Execute() functions for this table.
 */


class SysView_Transactions : public SysView_SysViewBase
{
...
public:
    ...
    /*!
       ...
       @return  none
     */
    SysView_Transactions(SQLMan_Context  &context,
...
#endif  /* SYSVIEW_TRANSACTIONS_HPP */
