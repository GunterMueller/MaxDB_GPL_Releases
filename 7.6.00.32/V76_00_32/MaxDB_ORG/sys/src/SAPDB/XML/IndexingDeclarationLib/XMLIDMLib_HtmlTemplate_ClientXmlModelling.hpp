#ifndef XMLIDMLIB_HTMLTEMPLATE_CLIENTXMLMODELLING_HPP
#define XMLIDMLIB_HTMLTEMPLATE_CLIENTXMLMODELLING_HPP
/****************************************************************************

  module      : XMLIDMLib_HtmlTemplate_ClientXmlModelling.hpp
...
*****************************************************************************/
	...
	// Defines
	//===================================================================*/
	#define TEMPLATE_CLIENT_XMLMODELLING					"XMLIDMLib_Html_ClientXmlModelling.htm"
	...
	/*===================================================================
	// Class XMLIDMLib_HtmlTemplate_ClientXmlModelling
	//===================================================================*/
	class XMLIDMLib_HtmlTemplate_ClientXmlModelling : public Tools_Template 
	{
		public:

			XMLIDMLib_HtmlTemplate_ClientXmlModelling(sapdbwa_WebAgent & wa,
										   			  sapdbwa_HttpRequest &req);
			
			~XMLIDMLib_HtmlTemplate_ClientXmlModelling();
