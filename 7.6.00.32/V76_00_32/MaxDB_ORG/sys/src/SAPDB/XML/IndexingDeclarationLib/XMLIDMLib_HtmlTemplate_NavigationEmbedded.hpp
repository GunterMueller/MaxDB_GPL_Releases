#ifndef XMLIDMLIB_HTMLTEMPLATE_NAVIGATIONEMBEDDED_HPP
#define XMLIDMLIB_HTMLTEMPLATE_NAVIGATIONEMBEDDED_HPP
/****************************************************************************

  module      : XMLIDMLib_HtmlTemplate_NavigationEmbedded.hpp
...
*****************************************************************************/
	...
	// Defines
	//===================================================================*/
	#define TEMPLATE_EMBEDDED_NAVIGATION			"XMLIDMLib_Html_NavigationEmbedded.htm"
	...
	/*===================================================================
	// class XMLIDMLib_HtmlTemplate_NavigationEmbedded
	//===================================================================*/
	class XMLIDMLib_HtmlTemplate_NavigationEmbedded : public Tools_Template 
	{
		public:

			XMLIDMLib_HtmlTemplate_NavigationEmbedded(sapdbwa_WebAgent & wa,
										   sapdbwa_HttpRequest &req);
			
			~XMLIDMLib_HtmlTemplate_NavigationEmbedded();
