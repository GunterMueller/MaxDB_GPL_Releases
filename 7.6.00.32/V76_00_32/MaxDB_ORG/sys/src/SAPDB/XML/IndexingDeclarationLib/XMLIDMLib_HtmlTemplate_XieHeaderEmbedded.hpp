#ifndef XMLIDMLIB_HTMLTEMPLATE_XIEHEADEREMBEDDED_HPP
#define XMLIDMLIB_HTMLTEMPLATE_XIEHEADEREMBEDDED_HPP
/****************************************************************************

  module      : XMLIDMLib_HtmlTemplate_XieHeaderEmbedded.hpp
...
*****************************************************************************/
	...
	// Defines
	//===================================================================*/
	#define TEMPLATE_EMBEDDED_XIEHEADER						"XMLIDMLib_Html_XieHeaderEmbedded.htm"
	...
	/*===================================================================
	// Class XMLIDMLib_HtmlTemplate_XieHeaderEmbedded
	//===================================================================*/
	class XMLIDMLib_HtmlTemplate_XieHeaderEmbedded : public Tools_Template 
	{
		public:

			XMLIDMLib_HtmlTemplate_XieHeaderEmbedded(sapdbwa_WebAgent &wa,
										  sapdbwa_HttpRequest &req);
			
			~XMLIDMLib_HtmlTemplate_XieHeaderEmbedded();
