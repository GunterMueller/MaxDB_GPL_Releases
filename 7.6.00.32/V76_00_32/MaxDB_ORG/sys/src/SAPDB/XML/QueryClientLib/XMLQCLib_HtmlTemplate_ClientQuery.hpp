#ifndef XMLQCLIB_HTMLTEMPLATE_CLIENTQUERY_HPP
#define XMLQCLIB_HTMLTEMPLATE_CLIENTQUERY_HPP
/****************************************************************************

  module      : XMLQCLib_HtmlTemplate_ClientQuery.hpp
...
*****************************************************************************/
	...
	// Defines
	//===================================================================*/
	#define TEMPLATE_CLIENT_QUERY							"XMLQCLib_Html_ClientQuery.htm"
	...
	/*===================================================================
	// Class XMLQCLib_HtmlTemplate_ClientQuery
	//===================================================================*/
	class XMLQCLib_HtmlTemplate_ClientQuery : public Tools_Template 
	{
		public:

			XMLQCLib_HtmlTemplate_ClientQuery(sapdbwa_WebAgent & wa,
										   		 sapdbwa_HttpRequest &req);
			
			~XMLQCLib_HtmlTemplate_ClientQuery();
