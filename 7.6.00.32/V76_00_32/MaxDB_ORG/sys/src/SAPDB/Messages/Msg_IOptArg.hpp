...
#ifndef MSG_IOPTARG_HPP
#define MSG_IOPTARG_HPP

#include "SAPDBCommon/SAPDB_Types.hpp"

/*! Limit of tag length. */
#define MSG_IARG_TAG_LIMIT       255
/*! Default value for unknown tag */
#define MSG_IARG_UNKNOWN_TAG     "unknown"
/*! Default value for undefined value */
#define MSG_IARG_UNDEFINED_VALUE ((SAPDB_UTF8 const *)"")
...
/*!
  ...
  value string, but an empty tag string is not allowed! Use 'Msg_IOptArg::UnknownTag' instead!

  The implementator of an Msg_IOptArg derived class must be aware of this restriction and should validate it using assertions...

  For a derived general purpose message argument have a look at class Msg_Arg.
 */
class Msg_IOptArg
{
public:
     ...
     */
    virtual operator Msg_IOptArg const * () const = 0;
...
}; /* @endclass Msg_IOptArg */

#endif /* MSG_IOPTARG_HPP */
