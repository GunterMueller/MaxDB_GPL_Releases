...
print FILE_OUT "++  Copyright 2000-2008 by SAP AG\n";
print FILE_OUT "++\n";
...
print FILE_OUT "++ =========================================================\n";
print FILE_OUT "++ \@(#) SQLDBCM.en(s) 7.6.00.32 Build 000-000-000 $WRKDATE\n";
print FILE_OUT "++ =========================================================\n";
print FILE_OUT "++------------------ERRORS-----------------------------------------------\n";
print FILE_OUT "ENG -99999 SQLDBC ENGMSG 7.6.00.32 Build 000-000-000\n";
