...
static char ident_sr[] = "@(#)RTESys_MicroTime+nothread.c dated 2006-07-17 05:54:09 used 2008-05-09 02:15:10";
extern char *RTESys_MicroTime_nothread_force_data () { return( ident_sr ); }
static char ident_mf[] = "@(#)RTESys_MicroTime+nothread FAST I386 UNIX LINUX PTOC -REL30=1 -RELVER=R76 -LC_STATE=RAMP -COMPILER=UNDEF -MACHINE=UNDEF";
static char ident_cc[] = "@(#)RTESys_MicroTime+nothread cc -DREL30 -DLINUX -DI386 -DSAG -DSDB_RELEASE_070600 -I/home/gunter/SANDBOX/MaxDB/V76_00_32/MaxDB_DEV/usr/incl -I/home/gunter/SANDBOX/MaxDB/V76_00_32/MaxDB_DEV/sys/wrk/incl -I/home/gunter/SANDBOX/MaxDB/V76_00_32/MaxDB_DEV/sys/wrk/incl/SAPDB -DSYSV -D_SVID -I/usr/include/ncurses -w -Wall -D_FILE_OFFSET_BITS=64 -fPIC -DHAS_NPTL -fno-strict-aliasing -DSAPDB_FAST -O3 -march=pentium -mcpu=pentiumpro -I/home/gunter/SANDBOX/MaxDB/DevTool/incl ";
extern char *RTESys_MicroTime_nothread_force_whatinfo () { return( ident_cc ); }
