...
#define PROD_NAME_SP100               "SAP DB"
#define COMPANY_NAME_SP100            "SAP AG"
#define COPYRIGHT_RC_SP100            "Copyright \251 2000-2008 by SAP AG" /* Resource Copyright Strings */
#define COPYRIGHT_SP100               "Copyright 2000-2008 by SAP AG"
#define DATE_SP100                    "Date 2008-05-09"
#define SAPDB_PURPOSE_SP100           "ALL"               /* set by setbuildinfo.pl */
#define SAPDB_BUILD_STATE_SP100       "RAMP"                    /* set by setbuildinfo.pl */
#define SAPDB_RELSTAT_SP100           "/home/gunter/SANDBOX/MaxDB/V76_00_32/MaxDB_DEV/test"                     /* set by setbuildinfo.pl */

#if defined ( VSP100_CPP ) || defined ( RESOURCE_FILE )

#  define MAJOR_VERSION_NO_SP100         7               /* set by setbuildinfo.pl */
#  define MAJOR_VERSION_NO_STR_SP100    "7"              /* set by setbuildinfo.pl */

#  define MINOR_VERSION_NO_SP100         6               /* set by setbuildinfo.pl */
#  define MINOR_VERSION_NO_STR_SP100    "6"              /* set by setbuildinfo.pl */

#  define CORRECTION_LEVEL_SP100         0            /* set by setbuildinfo.pl */
#  define CORRECTION_LEVEL_STR_SP100    "0"           /* set by setbuildinfo.pl */

#  define BUILD_PREFIX_SP100            32                 /* set by setbuildinfo.pl */
#  define BUILD_PREFIX_STR_SP100        "032"     /* set by setbuildinfo.pl */
