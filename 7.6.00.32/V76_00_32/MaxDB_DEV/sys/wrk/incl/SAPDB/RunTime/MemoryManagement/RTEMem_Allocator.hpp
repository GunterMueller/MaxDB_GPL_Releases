...
public:
  ...
  */
  ...
  virtual bool DoNotUseForMessageOutputAllocation() const { return m_Allocator ? m_Allocator->DoNotUseForMessageOutputAllocation():false; }

  /*!
    @brief Return the identifier of this allocator

    @return "RTEMem_Allocator"
  */
  virtual const SAPDB_UTF8 * GetIdentifier() const 
   ...
   /*!----------------------------------------------------------------------
      @brief  Returns the number of allocation failures
