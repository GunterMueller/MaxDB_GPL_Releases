/*!
  @file           IFRConversion_DateConverter.h
  @author         D039759
...
\endif
*/
#ifndef IFRCONVERSION_DATECONVERTER_H
#define IFRCONVERSION_DATECONVERTER_H

#include "Interfaces/Runtime/Conversion/IFRConversion_ByteCharDataConverter.h"

/**
 * @ingroup IFR_DataConv
 * Converter for date values. This converter converts 
 * DATE values (consisting of year, month and day) into and from 
 * various types.
 */
class IFRConversion_DateConverter
...
public:
     ...
     */
    IFRConversion_DateConverter(IFR_ShortInfo& shortinfo,
                                SAPDBMem_IRawAllocator& allocator,
                                IFR_Connection& connection);
    
    virtual ~IFRConversion_DateConverter();
